...
const TRANSLATE={
	"zhtw": {
		...
		"errorlist": {
			...
			"ERROR_table_closed": "此牌桌已關閉，無法再加入選手",
		...
		"registerpage": {
			...
			"unseatall_btn": "全部退座（打散）",
			"unseatall_confirm": "確定要打散重抽嗎？將把所有在場選手變為未排桌，之後可用隨機排座重新抽桌。",
			"unseatall_done": "已退座 {n} 位選手",
			"unseatall_fail": "全部退座失敗"
		},
		"gtopage": {
			"title": "建議範圍參考",
...
"handrankingpage": {
		...
		"tableboardpage": {
			...
			"closebutton": "關閉牌桌",
			"openbutton": "開啟牌桌",
			"closeconfirm": "確定要關閉這張牌桌嗎？關閉後不會再有新選手進入。",
			"openconfirm": "確定要重新開啟這張牌桌嗎？",
			"closesuccess": "已關閉牌桌",
			"opensuccess": "已開啟牌桌",
			"togglefail": "操作失敗",
			"needmerge": "可併桌（無人）",
			...
			"balancedone": "已套用平衡",
			"balancefail": "平衡失敗",
			"unseatallbutton": "全部退座（打散）",
			"unseatallconfirm": "確定要打散重抽嗎？將把所有在場選手變為未排桌，之後可用隨機排座重新抽桌。",
			"unseatalldone": "已退座 {n} 位選手",
			"unseatallfail": "全部退座失敗",
			"nosession": "缺少場次 ID",
			"loadfail": "載入失敗",
			"noperm": "沒有權限檢視此看板"
		},
		"tablemanage": {
			"sectiontitle": "牌桌管理",
			"sectiondesc": "可對每桌直接併桌或關閉；已關閉的桌不會再有新選手進入。",
			"closedbadge": "已關閉",
			"playercount": "{occupied}/{maxseat} 人",
			"emptycount": "{n} 空位",
			"mergebutton": "併桌",
			"closebutton": "關閉牌桌",
			"openbutton": "重新開啟",
			"mergetitle": "併桌：選擇目標牌桌",
			"mergedesc": "把「{table}」的所有選手併到選定的目標桌，併桌後本桌會自動關閉。",
			"mergenotarget": "沒有可併入的開放牌桌",
			"mergeinsufficient": "空位不足",
			"mergeconfirm": "確定要把「{source}」的所有選手併到「{target}」嗎？併桌後「{source}」會自動關閉。",
			"mergeauto": "隨機分配到所有開放桌",
			"mergeautototal": "共 {n} 空位",
			"mergeautoconfirm": "確定要把「{source}」的所有選手隨機分配到所有開放牌桌嗎？併桌後「{source}」會自動關閉。",
			"mergesuccess": "已完成併桌",
			"mergeclosefail": "併桌完成，但自動關閉來源桌失敗，請手動關閉",
			"mergefail": "併桌失敗",
			"closeconfirm": "確定要關閉「{table}」嗎？關閉後不會再有新選手進入此桌。",
			"closesuccess": "已關閉牌桌",
			"opensuccess": "已重新開啟牌桌",
			"togglefail": "操作失敗",
			"loadfail": "載入牌桌資料失敗",
			"notables": "此場次尚無牌桌",
			"resulttitle": "「{source}」併入「{target}」",
			"resulttitlemulti": "「{source}」併入多桌",
			"resultclosed": "「{source}」已自動關閉，不會再有新選手進入。",
			"resultempty": "此次併桌沒有需要移動的選手。",
			"resultclose": "關閉",
			"cancel": "取消"
		},
		"controlpage": {
	...
	"en": {
		...
		"errorlist": {
			...
			"ERROR_table_closed": "This table is closed and cannot take new players",
		...
		"registerpage": {
			...
			"unseatall_btn": "Unseat All (Reshuffle)",
			"unseatall_confirm": "Reshuffle tables? All active players will be unseated, then use random seating to redraw.",
			"unseatall_done": "Unseated {n} players",
			"unseatall_fail": "Unseat all failed"
		},
		"gtopage": {
...
"handrankingpage": {
		...
		"tableboardpage": {
			...
			"openbutton": "Reopen Table",
			"closeconfirm": "Close this table? No new players will be seated here.",
			"openconfirm": "Reopen this table?",
			"closesuccess": "Table closed",
			"opensuccess": "Table reopened",
			...
			"unseatallbutton": "Unseat All (Reshuffle)",
			"unseatallconfirm": "Reshuffle tables? All active players will be unseated, then use random seating to redraw.",
			"unseatalldone": "Unseated {n} players",
			"unseatallfail": "Unseat all failed",
		...
		"tablemanage": {
			...
			"sectiondesc": "Merge or close each table directly. Closed tables take no new players.",
			"closedbadge": "Closed",
			"playercount": "{occupied}/{maxseat} players",
			"emptycount": "{n} empty",
			"mergebutton": "Merge",
			"closebutton": "Close Table",
			"openbutton": "Reopen",
			"mergetitle": "Merge: Select Target Table",
			"mergedesc": "Move every player on \"{table}\" to the selected target table. This table closes automatically after merging.",
			"mergenotarget": "No open table available to merge into",
			"mergeinsufficient": "Not enough empty seats",
			"mergeconfirm": "Merge every player on \"{source}\" into \"{target}\"? \"{source}\" will be closed automatically afterwards.",
			"mergeauto": "Randomly distribute to all open tables",
			"mergeautototal": "{n} empty seats in total",
			"mergeautoconfirm": "Randomly distribute every player on \"{source}\" across all open tables? \"{source}\" will be closed automatically afterwards.",
			"mergesuccess": "Table merged",
			"mergeclosefail": "Merged, but auto-closing the source table failed. Please close it manually.",
			"mergefail": "Merge failed",
			"closeconfirm": "Close \"{table}\"? No new players will be seated at this table afterwards.",
			"closesuccess": "Table closed",
			"opensuccess": "Table reopened",
			"togglefail": "Operation failed",
			"loadfail": "Failed to load table data",
			"notables": "No tables in this session",
			"resulttitle": "\"{source}\" merged into \"{target}\"",
			"resulttitlemulti": "\"{source}\" merged into multiple tables",
			"resultclosed": "\"{source}\" is now closed. No new players will be seated there.",
			"resultempty": "No players needed to move in this merge.",
			"resultclose": "Close",
			"cancel": "Cancel"
		},
		"controlpage": {
