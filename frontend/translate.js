...
const TRANSLATE={
	"zhtw": {
		...
		"sessionpage": {
			...
			"tplimportprefix": "匯入 ",
			"tplbroadcasthint": "僅「統一手牌紀錄 + 公開場次」可轉播；開放後手牌分頁會出現「現場轉播」按鈕，供場外唯讀觀看。",
			...
			"tplcolumnorder": "欄位順序",
			"tpldelaybroadcast": "延遲播出（分鐘）",
			"tplopenbroadcast": "開放場外轉播",
			"tplshowhole": "顯示底牌",
			"tplshowtimer": "顯示計時器",
			"tplbigscreen": "大螢幕顯示",
			"tplaccentcolor": "主色",
			"tplallinhands": "All-in 手數",
			"tplh4hmanual": "H4H 手動推進",
...
"handrankingpage": {
	...
	"en": {
		...
		"sessionpage": {
			...
			"tplbroadcasthint": "Only sessions with unified hand records that are public can be broadcast. Once enabled, a Live Broadcast button appears on the Hands tab for read-only outside viewing.",
			...
			"tpldelaybroadcast": "Broadcast delay (minutes)",
			"tplopenbroadcast": "Enable Outside Broadcast",
			"tplshowhole": "Show Hole Cards",
			"tplshowtimer": "Show Timer",
			"tplbigscreen": "Big Screen Display",
			"tplaccentcolor": "Accent Colour",
			"tplallinhands": "All-in Hands",
			"tplh4hmanual": "H4H Manual Advance",
		...
		"broadcastpage": {
			"bbtogglelabel": "Toggle big-blind (BB) units",
			"skinlabel": "Choose card face and back style",
...
"handrankingpage": {
		...
		"guidepage": {
			"title": "Guide",
			"description": "PokerTrace guide covering sessions, registration and seating, the timer, hand logging, stats and payouts, series, broadcast and replay, following organizers, staff hiring, on-site check-in, and the tool center.",
			"heading": "Guide",
			"lead": "This page organizes the complete PokerTrace workflows. Jump straight to the section that matches your role and what you need right now — from session setup, registration and seating, the timer, hand logging, and stats and payouts, to series, broadcast and replay, following organizers, staff hiring, on-site check-in and receipts, and the tool center.",
