...
const TRANSLATE={
	"zhtw": {
		...
		"registerpage": {
			...
			"helpcancelledtext": "這筆報名已失效；若已淘汰則需看再入場額度是否仍可用。",
			"helpflow1": "先搜尋或新增選手，確認是不是要用現金 / 票券報名。",
			"helpflow2": "先批次確認，再做未入座補位或平均排座，避免座位混亂。",
			"helpflow3": "現場淘汰或多日賽時，再處理 Reentry、晉級與收益修正。",
			...
			"updatechip": "更新計分牌",
			"printreceipt": "列印收據",
			"reentrymaxed": "Reentry 已達上限",
			"seatafterconfirm": "確認後可排座",
			"bustedneedreentry": "已淘汰，請先 Reentry",
