...
const TRANSLATE={
	"zhtw": {
		"scanpage": {
			"heading": "掃描報到 QR",
			"desc": "將選手收據上的 QR 對準相機，辨識後會自動開啟該筆報到核對頁。",
			"restart": "重新啟動相機",
			"manualgo": "查詢",
			"aim": "將 QR 對準框內…",
			"going": "已辨識，前往報到頁…",
		...
		"checkinpage": {
			"backregister": "回報名工作台",
			"backsessionlist": "場次列表",
			"advancefollowed": "此收據為「{from}」的報到憑證，該選手已晉級，以下顯示「{current}」",
			"statusregistered": "已報名",
			"statusconfirmed": "已確認",
			"statusadvanced": "已晉級",
			"statuscancelled": "已取消",
			"noseat": "未排座",
		...
		"staffworkpage": {
			"title": "員工工時",
			"subtitle": "計分員、裁判與助理的打卡時數與應付金額。計費以 30 分鐘為單位無條件進位。",
			"tabreport": "跨場次累計",
			"tabsession": "單場明細",
			"startdate": "起始日",
			"enddate": "結束日",
			...
			"loadfail": "載入失敗",
			"emptyall": "還沒有任何工時紀錄",
			"emptyallnext": "到場次頁的員工分頁替員工打上班卡，紀錄就會出現在這裡。",
			"emptysearch": "這個區間沒有工時紀錄",
			"emptysession": "這場還沒有工時紀錄",
			"emptysessionnext": "到場次頁的員工分頁替員工打上班卡。",
			"backfill": "補下班卡",
			"backfillneedtime": "請先選下班時間",
			"backfillok": "已補下班卡",
			"backfillfail": "補登失敗"
		},
		"staffwork": {
			...
			"shiftresume": "結束休息",
			"shiftend": "下班卡",
			"startstaffshiftok": "已打上班卡",
			"breakstaffshiftok": "已開始休息",
			"resumestaffshiftok": "已結束休息",
			"endstaffshiftok": "已打下班卡",
			"shiftok": "已更新",
			"shiftfail": "操作失敗",
			"shiftloadfail": "打卡狀態載入失敗",
			"stateoff": "未上班",
			"stateworking": "工作中",
			"stateonbreak": "休息中",
			"attable": "目前牌桌",
			...
			"colrate": "時薪",
			"colamount": "金額",
			"cardtotalminute": "本場總時數",
			"cardtotalamount": "本場總金額",
			"cardworking": "上班中",
			"emptystaff": "這場沒有可排班的員工",
			"emptystaffnext": "請先到個人檔案聘用計分員、裁判或助理，或為本場次單獨指派。",
			"emptystaffgoprofile": "前往個人檔案聘用",
			"paneltitle": "員工總覽",
			"filterall": "全部",
			"filterworking": "上班中",
			"filteridle": "空閒",
			...
			"filteronbreak": "休息中",
			"filteroff": "未打卡",
			"filterempty": "這個條件沒有符合的員工",
			"searchplaceholder": "搜尋姓名或編號",
			"colname": "姓名",
			"colstate": "狀態",
			"picktablehint": "從桌卡指派",
			"pendingonly": "已指派，等待對方確認",
			"pendingonlynext": "對方點了邀請信裡的連結之後，就會出現在排班清單中。",
			"pendingtitle": "待確認的邀請",
			"pendinghint": "對方確認之前不會出現在排班清單，也不能上桌或打卡。",
			"pendingbadge": "待確認",
			"pendingsourcesession": "本場指派",
			"pendingsourceglobal": "長期聘用",
			"billinghint": "計費以 30 分鐘為單位無條件進位；上班中的班不計金額。",
			"assigntitle": "指派本場員工",
			"assignhint": "只在這一場生效，不影響其他場次。長期聘用請到個人檔案設定。",
			"assignplayerid": "選手編號",
			"assignbutton": "指派",
			"assignok": "已指派",
			"assignfail": "指派失敗",
			"assignneedplayerid": "請輸入選手編號",
			"removesession": "移除",
			"removeconfirm": "確定要把這位員工從本場次移除嗎？",
			"removeok": "已移除",
			"removefail": "移除失敗",
			"leavetable": "下桌",
			"leaveok": "已下桌",
			...
			"assigntable": "指派值班",
			"assigntitle2": "指派值班員工",
			"assigndesc": "選一位員工到這張桌。原本在別桌的會自動換過來；還沒打卡的會順便打上班卡。",
			"assignok2": "已上桌",
			"assignokclock": "已上桌，並自動打了上班卡",
			"assignfail2": "指派失敗",
			"noassignable": "沒有可指派的員工",
			"stateidle": "空閒",
			"stateontable": "在",
			"statenoclock": "未打卡",
			"overlapwarn": "這張桌同角色已有人，兩位會同時在桌（交接中）。",
			"ratesession": "本場覆寫",
			"rateglobal": "全域預設",
			"ratesave": "存",
			"rateok": "時薪已更新，只影響之後的打卡",
			"ratefail": "更新失敗"
		},
		"sessionpage": {
			"boardrun": "第 {n} 次",
			"colornotinpalette": "（不在調色盤中）",
			"printsessionname": "場次名稱",
			"printcode": "代碼",
			"printdate": "日期",
			"printreentryfee": "再入次數/再入費",
			"printrebuyfee": "重買次數/重買費",
			"printaddonfee": "增購次數/增購費",
			"printsessionended": "場次結束",
			"tplimportprefix": "匯入 ",
			"tplcolumnorderhint": "欄位順序只在寬度大於 900px 的螢幕生效。手機與平板的大螢幕頁是另一套上下堆疊的版面，沒有三欄可以調整。",
			"tpldisplaysettinghint": "這些設定只影響本場次的 display.html 大螢幕。留空的欄位代表沒有設定，大螢幕就維持預設外觀。",
			"tpllogourlhint": "只接受 http／https 開頭的網址。大螢幕會把高度限制在 34px，建議準備橫式、去背的圖。",
			"tplquickentryhint": "把這個角色最常用的動作集中在這裡，避免同頁資訊過載。",
			"tplnoseathint": "尚未找到你的座位。若已報名，請等待主辦確認並排座。",
			"tpldeletehint": "刪除後此賽事不會再出現在列表中。",
			"tplchipsethint": "可到個人資料設定常用計分牌組合",
			"tplnolinkedplayer": "此場次沒有開啟關聯選手。",
			"tplnomatchlinked": "目前沒有符合條件的關聯選手。",
			"tplnolinkedplayernow": "目前沒有關聯選手。",
			"tplnomatchplayer": "目前沒有符合條件的選手。",
			"tplnohandpermission": "目前沒有手牌檢視權限",
			"tplnopayout": "目前沒有 payout 設定。",
			"tplnorelation": "沒有可關聯的賽事",
			"tplregisteredwait": "你已報名，等待主辦確認。",
			"tplbadgeregistered": "⏳ 已報名, 等待主辦確認",
			"tplbadgeconfirmed": "✅ 已確認入場",
			"tplsessionloading": "場次資料載入中...",
			"tplserieslodaing": "賽事資料載入中...",
			"tpltablesearcherror": "查詢牌桌時遭遇錯誤",
			"tplnotable": "查無牌桌",
			"tplsearchseries": "搜尋賽事名稱 / token",
			"tplsearchplayerfull": "查詢選手 / ID / 桌位 / 名次",
			"tplsearchplayertable": "查詢選手名稱 / ID / 牌桌",
			"tpltablenoplaceholder": "牌桌編號",
			"tplregisterthis": "報名此場次",
			"tplreregister": "重新報名 / 再入",
			"tplunregister": "取消報名",
			"tpldeletealltable": "刪除所有牌桌",
			"tplsavemultiday": "儲存多日賽關聯",
			"tplsavesatellite": "儲存衛星賽關聯",
			"tpladdchiprow": "新增計分牌",
			"tpldeletesession": "刪除賽事",
			"tplsavegamesetting": "儲存牌局設定",
			"tplsavegeneralsetting": "儲存一般設定",
			"tpltimerconsole": "🎛️ 計時器控制台",
			"tplregisterlist": "👥 報名清單",
			"tplcheckin": "✅ 報到核對",
			"tplmycheckin": "✅ 我的報到核對",
			"tpldisplaypage": "📺 顯示頁 (新分頁)",
			"tplbrandname": "品牌／協會名稱",
			"tpllogourl": "Logo 圖片網址",
			"tplblockstoshow": "要顯示的區塊",
			"tplcolumnorder": "欄位順序",
			"tplshowtimer": "顯示計時器",
			"tplbigscreen": "大螢幕顯示",
			"tplaccentcolor": "主色",
			"tplallinhands": "All-in 手數",
			"tploriginalprize": "/ 原獎池",
			"tplsuggestnext": "建議下一步",
			"tplyourrole": "你的角色",
			"tplwhatnext": "你下一步該做什麼",
			"tplquickentry": "快速入口",
			"tplfocusnow": "現在先看這些",
			"tplmyseat": "我的座位",
			"tplmodifystructure": "修改結構",
			"tplviewstructure": "查看結構",
			"tpladdtable": "新增牌桌",
			"tplhostgame": "主辦牌局",
			"tplgeneral": "一般",
			"tplgamesetting": "牌局設定",
			"tplseriesrelation": "賽事關聯",
			"tplmultidayrelation": "多日賽關聯",
			"tplsatelliterelation": "衛星賽關聯",
			"tplmultiday": "多日賽",
			"tplsatellite": "衛星賽",
			"tplplayerstatusprize": "選手狀態與獎金",
			"tplusechipdenom": "使用計分牌面額",
			"tplchiptype": "計分牌類型",
			"tplround": "圓形",
			"tplsquare": "方形",
			"tplautostartbytime": "依照時間自動開始",
			"tplallowticket": "允許票券買入",
			"tplunifiedhand": "統一紀錄手牌",
			"tplprivategame": "私人牌局",
			"tplopenregistration": "開放報名",
			"tpllinkuser": "使用者連結",
			"tplmaxseatcount": "每桌座位數",
			"tpllimittype": "限注類型",
			"tplgametype": "遊戲類型",
			"tpleventdetail": "賽事細項",
			"tplstartdate": "開始日期",
			...
			"tabstats": "統計",
			"tabsettings": "設定",
			"tableboardentry": "多牌桌總覽",
			"colaction": "操作",
			"colstarthand": "起手牌",
			"colimportance": "重要性",
			"handrecordtitle": "手牌紀錄",
			"statstitle": "統計數據",
			"printsession": "列印場次",
			"printhand": "列印手牌",
			"venuesearchlabel": "牌桌地點搜尋",
			"handsearchplaceholder": "搜尋 table / 選手 / Seat",
			"handsearchlabel": "搜尋牌桌、選手或座位",
			"handfromlabel": "手牌起始日期",
			"handtolabel": "手牌結束日期",
			"handseatlabel": "座位篩選",
			"chartstacktitle": "累積計分牌量圖表",
			"chartstacknote": "統計本場次所有牌桌，左側為最舊手牌、右側為最新手牌，數值為每手結束後的累積計分牌量。",
			"chartprofit": "損益",
			"orderinfoshare": "識別與分享",
			"orderinfotoken": "場次代碼",
			"orderinfolink": "場次連結",
			"orderinfobasic": "基本資料",
			"orderinfoname": "名稱",
			...
			"orderinfostart": "開始時間",
			"orderinfoend": "結束時間",
			"orderinfocreate": "建立時間",
			"orderinfosystem": "系統識別",
			"orderinfoid": "場次編號",
			"orderinfoidnote": "回報問題時附上這個編號，可以更快找到這一場。",
			"orderinfocopy": "複製",
			"orderinfocopied": "已複製到剪貼簿",
			"orderinfocopyfailed": "複製失敗，請手動選取",
			"tplplace": "名次",
			"tplbuyin": "買入",
			"tplchip": "計分牌",
			"tplante": "前注",
			"tplbigblindante": "大盲前注",
			"tplshow": "顯示",
			"tpledit": "編輯",
			"tpldelete": "刪除",
			"tpladd": "加入",
			...
			"handsortdesc": "時間新→舊",
			"handsortasc": "時間舊→新",
			"handsectiontitle": "手牌總覽",
			"handempty": "尚無手牌",
			"handtitlesuffix": " 手牌總覽",
			"handsubtitle": "手牌紀錄存底",
			"chipunit": "碼",
			"tablenoheader": "牌桌編號",
			"statusended": "End (已結束)",
			"statusrunning": "Running (進行中)",
			"statuslatereg": "Late Reg. (報名中)",
			"badgelatereg": "報名中",
			"badgerunning": "進行中",
			"badgeended": "已結束",
			"titlemyrecord": "個人紀錄",
			"hintmyrecord": "可快速修改重購次數、名次、總買入等個人場次結果。",
			"titlehostaction": "主辦操作",
			"contrastfailprefix": "對比不足（",
			"contrastfailsuffix": ":1）。這個顏色在大螢幕深色底上會看不清楚，建議改用更亮的顏色。",
			"contrastwarnprefix": "對比偏低（",
			"contrastwarnsuffix": ":1）。遠處觀看可能吃力，建議實際在現場螢幕確認。",
			"printnorank": "尚無名次資料",
			"printcolno": "序號",
			"printcolstatus": "狀態",
			"printcoltable": "桌次",
			"printcolseat": "座位",
			"printcolprofit": "盈虧",
			"printnoregistration": "尚無報名紀錄",
			"printcolstart": "開始",
			"printcollevel": "關卡",
			"printcolsb": "小盲",
			"printcolbb": "大盲",
			"printcolante": "前注",
			"printcolduration": "時間(分)",
			"printcolnote": "備註",
			"printchipraise": "換籌 ",
			"printbreak": "休息",
			"printnostructure": "尚無結構資料",
			"printnotloaded": "場次資料尚未載入完成，請稍候再列印",
			"printsectionsummary": "場次摘要",
			"printsectionregstats": "報名統計",
			"printstatregistered": "已報名",
			"printstatconfirmed": "已確認",
			"printstatcancelled": "已取消",
			"printstatcount": "報名筆數",
			"printsectionrank": "名次結算",
			"printsectionreglist": "報名名單",
			"printsectionstructure": "賽事結構",
			"printsignstaff": "承辦人簽名",
			"printsignmanager": "主管簽名",
			"printsessionfallback": "場次",
			"printtitlesuffix": " 場次存底",
			"printsubtitle": "場次詳情存底",
			"confirmdelete": "確定刪除?",
			"deletesuccess": "刪除成功",
			"deletefail": "刪除失敗",
			"loadslow": "載入時間較久, 請檢查連線後重試",
			"rankbusted": "已淘汰",
			"rankrunning": "進行中...",
			"rankadvancedwith": "已晉級 (",
			"rankadvanced": "已晉級",
			"cardvenue": "地點",
			"cardgametypelabel": "遊戲類型",
			"cardprofit": "盈虧",
			"cardplace": "名次",
			"confirmdeleteforever": "確定刪除? 此操作無法復原!",
			"sessionnotfound": "查無指定場次",
			"linkopened": "本場次已開放關聯使用者報名",
			"linkclosed": "本場次未開放關聯使用者報名",
			"titlehired": "已聘用",
			"hintstaffnoreg": "已聘用員工不能報名此場次。",
			"titleregister": "報名",
			"hintregclosed": "目前未開放報名。",
			"registersuccess": "報名成功，等待主辦確認",
			"erralreadyregistered": "您已經報名過了",
			"errownsession": "不能報名自己主辦的場次",
			"errstaffnoreg": "已聘用員工不能報名此場次",
			"errsessionended": "此場次已結束",
			"errregclosed": "此場次未開放報名",
			"confirmcancelreg": "確定要取消報名嗎?",
			"cancelregdone": "已取消報名",
			"rebuymax": "重買次數上限",
			"rebuycount": "重買次數",
			"reentrymax": "再入次數上限",
			...
			"addoncount": "增購次數",
			"importedprefix": "已匯入 ",
			"chipsetdefault": "計分牌組合",
			"blockpayout": "獎金欄（整列，含獎金池與其他獎勵）",
			"blockstack": "平均計分牌與報名數",
			"blocknextblind": "下一級盲注與進度條",
			"blockmarquee": "跑馬燈與其他獎勵",
			"orderdefault": "預設（獎金 / 計時器 / 資訊）",
			"orderpci": "獎金 / 計時器 / 資訊",
			"orderpic": "獎金 / 資訊 / 計時器",
			"ordercpi": "計時器 / 獎金 / 資訊",
			"ordercip": "計時器 / 資訊 / 獎金",
			"orderipc": "資訊 / 獎金 / 計時器",
			"ordericp": "資訊 / 計時器 / 獎金",
			"hintdefaultcolor": "未設定主色時使用內建的綠色。",
			"contrastlowsuffix": "對比良好（",
			"relationoutgoing": "本賽事通往其他賽事",
			"relationincoming": "其他賽事通往本賽事",
			"relationsatellite": "衛星賽：source 可取得 target 票券",
			"relationmultiday": "多日賽：source 晉級 target",
			"confirmdeleteseries": "確定刪除此賽事?",
			"savesuccess": "儲存成功",
			"actionblind": "盲注",
			"cumulativechip": "累積計分牌",
			"sorttime": "時間 ",
			"statusregistered": "已報名",
			"statusconfirmed": "已確認",
			"statusadvanced": "已晉級",
			...
			"cardbuyinfee": "買入(服務費)",
			"cardbuyinchip": "買入計分牌",
			"cardticketvalue": "票券價值",
			"cardguaranteed": "保底獎金",
			"sectionbuyinrule": "買入規則",
			"rulereentry": "可再入",
			"rulerebuy": "可重買",
			"ruleaddon": "可增購",
			"sectionsessionsetting": "場次設定",
			"setticketenabled": "允許票券",
			"setregclosed": "報名截止",
			"setlinkuser": "使用者連結",
			"setopenregistration": "開放報名",
			"setprivate": "私人牌局",
			"setsessionended": "場次結束",
			"setunifiedhand": "統一手牌紀錄",
			"setautostart": "依時間自動開始",
			"paymentticket": "票券",
			"paymentcash": "現金",
			"cardmyentry": "我的入場",
			"cardmyplace": "我的名次",
			...
			"cardmyprofit": "我的盈虧",
			"levelbreak": "休息",
			"roleopenstatus": "目前開放報名",
			"roleopennext": "先看規則與時間，確認沒問題後直接報名。",
			"roleopencta": "立即報名",
			"roleopenfocus": "選手首屏會先把是否能報名和你接下來該做什麼講清楚。",
			"roleopenhelper": "不需要先翻到手牌、設定或其他管理資訊。",
			"roleclosedstatus": "目前未開放報名或尚未與選手報名連結",
			"roleclosednext": "先確認開賽時間、報名條件與主辦公告。",
			"infocurrentrole": "目前身份",
			"inforegstatus": "報名狀態",
			"infonotregistered": "未報名",
			"infotimer": "計時器",
			"infotimerlinked": "可連動",
			"infotimerunlinked": "未連動",
			"inforegistration": "報名",
			"inforegopen": "開放中",
			"inforegclosed": "未開放",
			"guidehost1": "先檢查目前是否開放報名、是否需要切去報名清單處理現場名單。",
			"guidehost2": "若場次進行中，優先確認計時器與報名關閉狀態。",
			"guidehost3": "需要調整規則時再進入其他設定，避免現場分心。",
			"guidestaff1": "先確認當前關卡、剩餘人數與報名是否已關閉。",
			"guidestaff2": "有現場節奏需要處理時，再進控制台執行操作。",
			"guidestaff3": "若只需查看資訊，留在總覽即可，不必先進設定。",
			"guidehired1": "先確認自己是以員工身份協助，不需要執行選手報名動作。",
			"guidehired2": "查看目前場次狀態與座位 / 進度資訊。",
			"guidehired3": "有需要再配合主辦進入對應工具頁。",
			"guideplayer1": "先看目前是否開放報名與你的報名狀態。",
			"guideplayer2": "已確認入場再看個人名次、座位與計時器資訊。",
			"guideplayer3": "深層資料如手牌與其他設定放在後面，需要時再進去。",
			"quickregisterdesk": "報名工作台",
			"quicktimerconsole": "計時器控制台",
			"quickdisplaypage": "顯示頁",
			"quicksessionsettings": "場次設定",
			"quickgotoconsole": "前往控制台",
			"quickviewtable": "查看牌桌",
			"quickoverview": "總覽資訊",
			"quicktableseat": "牌桌 / 座位",
			"quicktimerdisplay": "計時器顯示",
			"roleplayer": "選手",
			"roleplayerstatus": "可查看場次資訊",
			"roleplayernext": "先確認時間、地點與目前是否開放報名。",
			"roleplayercta": "查看總覽",
			"roleplayerfocus": "你現在先需要的是場次基本資訊與報名狀態。",
			"roleplayerhelper": "完成必要動作後，再往下看牌桌、手牌或其他細節。",
			"rolehost": "主辦 / 管理",
			"rolehoststatus": "可管理報名、計時器、設定與場次結構",
			"rolehostnext": "先檢查報名狀態與計時器，再決定是否要進入管理區。",
			"rolehostcta": "前往管理區",
			"rolehostfocus": "主辦版首屏會優先給你管理入口與現場執行工具。",
			"rolehosthelper": "報名清單、計時器控制台與場次設定會集中在快速入口。",
			"rolefloor": "裁判",
			"roleassistant": "助理",
			"rolestaffstatus": "可協助現場流程，並可操作計時器",
			"rolestaffnext": "先確認目前報名 / 計時器狀態，再進入控制台執行現場操作。",
			"rolestaffcta": "開啟計時器控制台",
			"rolestafffocus": "你現在最重要的是知道目前節奏、報名是否關閉、以及下一步現場流程。",
			"rolestaffhelper": "深層設定不會放在首屏，先把現場執行需要的資訊看清楚。",
			"rolehired": "已聘用員工",
			"rolehiredstatus": "可查看相關場次並協助執行，但不會以選手身份報名",
			"rolehirednext": "先確認你的協助範圍與目前場次狀態。",
			"rolehiredcta": "查看場次狀態",
			"rolehiredfocus": "員工版首屏會先給你必要資訊，不會把選手報名動作放在前面。",
			"rolehiredhelper": "若你是裁判或助理，會另外顯示計時器相關入口。",
			"roleregisteredstatus": "你已報名，等待主辦確認",
			"roleregisterednext": "保留這頁追蹤確認狀態，若行程有變可取消報名。",
			"roleregisteredcta": "查看我的狀態",
			"roleregisteredfocus": "你現在最重要的是等候確認，不需要先看深層管理資訊。",
			"roleregisteredhelper": "確認後再留意座位、剩餘人數與計時器顯示。",
			"roleconfirmedstatus": "你已確認入場",
			"roleconfirmednext": "先確認自己的名次 / 入場資料，再視需要看牌桌或計時器。",
			"roleconfirmedcta": "查看我的資料",
			"roleconfirmedfocus": "你的首屏會優先展示個人結果與接下來要注意的資訊。",
			"roleconfirmedhelper": "如果你已淘汰且可再入場，主動作會改成再入場。",
		},
		"sessionresult": {
			"title": "我的成績",
		...
		"toolseo": {
			...
			"apidocbody": "PokerTrace 的部分小工具提供公開 API，可以在你自己的網站、Discord 機器人或試算表裡直接呼叫，例如勝率計算與 ICM。本頁列出各端點的網址、參數與回傳格式，全部免費、不需要金鑰即可使用。",
			...
			"chipcolorbody": "白 1、紅 5、綠 25、黑 100 是最常見的現金桌配置，比賽計分牌則常用 25、100、500、1000、5000 的組合。本頁整理常見計分牌顏色與面額慣例，佈置新場地或採購計分牌時可直接參考；登入並在個人資料設定計分牌組合後，上方會改為顯示你自己的牌組。",
			...
			"chipracebody": "移除小面額時，湊不滿一顆大計分牌的零頭傳統上用發牌比大小（chip race）決定歸屬。這個工具幫你算出全桌要準備多少顆新計分牌，以及換不完的全桌餘值；實際發牌時再依「一人最多得一顆、不會因 race 出局」等標準規則處理各家零頭。",
			...
			"equitybody": "輸入你和對手的手牌（支援德州、奧馬哈、奧馬哈高低、Big O 與短牌）與公共牌，工具即時計算各家勝率、平手率與剩餘 outs；高低分池的牌型改顯示平均分池份額與通吃率。可以用來複盤關鍵手牌、驗證全下決策，或單純弄清楚 AK 對 QQ 到底是幾比幾。",
			...
			"handbooktitle": "撲克玩法手冊",
			"handbookbody": "這份手冊整理常見玩法與變體，包含德州、奧馬哈、抽牌與梭哈類遊戲。每個項目用短格式列出手牌張數、發牌流程與勝負判定，適合主辦、裁判、計分員與選手在開局前快速對齊規則。",
		...
		"errorlist": {
			...
			"ERROR_invalid_gametype_code": "遊戲類型代碼只能使用英文大寫與數字",
			"ERROR_duplicate_gametype_code": "遊戲類型代碼已存在",
			"ERROR_zz_required": "ZZ 是必要的其他類型，不能刪除",
			...
			"ERROR_icm_no_player": "沒有可分配 ICM 的在場選手",
			"ERROR_icm_player_limit": "ICM 分配最多支援 18 位在場選手",
			"ERROR_icm_chip_missing": "在場選手缺少計分牌數，無法分配 ICM",
			"ERROR_icm_no_prize": "沒有可分配的獎金設定",
			...
			"ERROR_staff_already_clockedin": "已經在上班中，不需要重複打卡",
			"ERROR_staff_not_clockedin": "目前不在上班中，請先打上班卡",
			"ERROR_staff_already_onbreak": "已經在休息中",
			"ERROR_staff_not_onbreak": "目前不在休息中",
			"ERROR_follow_not_found": "查無追隨紀錄",
			"ERROR_follow_target_not_found": "查無可追隨的主辦單位",
			"ERROR_cannot_follow_self": "不能追隨自己",
			"ERROR_staff_already_ontable": "這位人員已經在其他牌桌值班中",
			"ERROR_staff_not_found": "找不到這位人員",
			"ERROR_tablestaff_not_found": "找不到這筆上桌紀錄",
			"ERROR_worklog_not_found": "找不到這筆工時紀錄",
			"ERROR_worklog_time_invalid": "時間不正確，結束時間必須晚於開始時間且不能是未來",
			"ERROR_worklog_time_overlap": "這段時間與既有的工時紀錄重疊",
			"ERROR_staff_already_invited": "已經邀請過這位人員",
			"ERROR_staff_self_invite": "不能邀請自己",
			"ERROR_staff_role_mismatch": "這位人員的帳號類型與要指派的角色不符",
			"ERROR_staff_cannot_register": "受聘人員不能報名自己服務的賽事",
			"ERROR_seating_not_found": "找不到座位資料",
			"ERROR_verifytoken_invalid": "驗證連結已失效，請重新索取",
			"ERROR_confirm_text_error": "確認文字不正確",
			"ERROR_datatype_error": "資料型別不正確",
			"ERROR_deleteuser_error": "刪除使用者失敗，請稍後再試",
			"ERROR_deleteuseraccount_error": "刪除帳號失敗，請稍後再試",
		...
		"profile": {
			"staffidlabel": "使用者 ID",
			"colornotinpalette": "（不在調色盤中）",
			"cardfacecardtitle": "牌面配色",
			"cardfacecarddesc": "全站生效，包含手牌明細、場次手牌與牌桌。",
			"cardfacetwo": "傳統兩色",
			"cardfacefour": "四色",
			"displaydefaultcardtitle": "大螢幕品牌預設",
			"displaydefaultcarddesc": "設定一次，之後每建一場賽事都會自動帶入。單場改動不會影響這裡。",
			"displaydefaultmodaldesc": "這些是新場次的初值。已經建立的場次不受影響，要改請到該場次的設定頁。",
			"emptydisplaydefault": "尚未設定大螢幕品牌預設",
			"displaydefaultname": "品牌／協會名稱",
			"displaydefaultlogo": "Logo 圖片網址",
			"displaydefaultlogohint": "只接受 http／https 開頭的網址。大螢幕會把高度限制在 34px，建議準備橫式、去背的圖。",
			"displaydefaultcolor": "主色",
			"displaydefaultclear": "清除",
			"displaydefaultblocks": "要顯示的區塊",
			"displaydefaultorder": "欄位順序",
			"displaydefaultorderhint": "欄位順序只在寬度大於 900px 的螢幕生效。手機與平板的大螢幕頁是另一套上下堆疊的版面，沒有三欄可以調整。",
			"displaydefaultcolorunset": "未設定主色時使用內建的綠色。",
			"displaydefaultcolorlow": "對比不足，這個顏色在大螢幕深色底上會看不清楚",
			"displaydefaultcolormid": "對比偏低，遠處觀看可能吃力",
			"displaydefaultcolorok": "對比良好",
			"displaydefaulthaslogo": "已設 logo",
			"displaydefaulthasorder": "已設欄位順序",
			"displaydefaulthidden": "隱藏區塊 ",
			"displayblockpayout": "獎金欄（整列，含獎金池與其他獎勵）",
			"displayblockstack": "平均計分牌與報名數",
			"displayblocknextblind": "下一級盲注與進度條",
			"displayblockmarquee": "跑馬燈與其他獎勵",
			"displayorderdefault": "預設（獎金 / 計時器 / 資訊）",
			"displayorderpci": "獎金 / 計時器 / 資訊",
			"displayorderpic": "獎金 / 資訊 / 計時器",
			"displayordercpi": "計時器 / 獎金 / 資訊",
			"displayordercip": "計時器 / 資訊 / 獎金",
			"displayorderipc": "資訊 / 獎金 / 計時器",
			"displayordericp": "資訊 / 計時器 / 獎金",
			"title": "個人資料",
			"playerid": "選手 ID",
			"monthreport": "月報表",
			"yearreport": "年報表",
			...
			"pending": "待確認",
			"filterall": "全部",
			"filterempty": "這個條件沒有符合的人",
			"filtersearch": "搜尋姓名或編號",
			...
			"toolequitydesc": "德州 / 奧馬哈 / 奧馬哈高低 / Big O / 短牌 手牌勝率與 outs",
			...
			"cardfaceskincardtitle": "牌面樣式",
			"cardfaceskincarddesc": "牌面可以選與牌背不同的樣式。",
			"carddeckcardtitle": "牌背樣式",
			"carddeckcarddesc": "選擇手牌回放的牌背樣式。",
			"decknotlisted": "（不在清單中）",
			"deckclassic": "經典藍",
			"deckcrimson": "緋紅",
			"deckmidnight": "午夜綠",
			...
			"gametypeadmincardtitle": "遊戲類型設定",
			"gametypeadmincarddesc": "新增與管理場次可用遊戲，並設定每種玩法的發牌、下注與勝負流程。",
			"gametypeadminopen": "前往設定",
		...
		"handdetailpage": {
			...
			"lowhand": "低牌",
			"boardrun": "第 {n} 次",
			"boardrunpot": "獎池 {amount}",
			"boardrunwinner": "座位 {seat} 得 {amount}",
			"multiboard": "跑 {n} 次",
			"burn": "燒牌",
			"unknown": "未知",
			"start": "起始",
			...
			"streetriver": "河牌",
			"actionblind": "盲注",
			"printnotloaded": "手牌資料尚未載入",
			"printhand": "手牌",
			"printdate": "日期",
			"printdealerseat": "莊家座位",
			"printrecord": "紀錄",
			"printpublicrecord": "公開紀錄",
			"printblind": "盲注",
			"printtotalpot": "總底池",
			"printherohand": "英雄手牌",
			"printboard": "公牌",
			...
			"printcolwon": "得標",
			"printwonyes": "是",
			"printnoseating": "無座位資料",
			"printcolstreet": "街",
			"printcolaction": "動作",
			"printcolamount": "金額",
			"printnoaction": "無行動資料",
			"printsectionnote": "備註",
			"printsectionboard": "牌面",
			"printsectionseating": "座位結果",
			"printsectionaction": "行動",
			"printtitleprefix": "手牌",
			"printtitlesuffix": "明細",
			"printsubtitle": "單筆手牌存底",
			"printmeta": "列印時間"
		},
		"follow": {
			"title": "追隨主辦單位",
			"desc": "追隨之後，對方開新場次時你會收到通知；場次列表也能用「追隨中」只看他們的賽事。",
			"privacynote": "這份清單只有你看得到，主辦單位不會知道誰追隨他。",
			"add": "新增追隨",
			"follow": "追隨",
			"following": "追隨中",
			"unfollow": "取消追隨",
			"unfollowconfirm": "確定要取消追隨嗎？取消後不會再收到新場次通知。",
			"unfollowed": "已取消追隨",
			"scope": "地點範圍",
			"scopeall": "全部地點",
			"scopeallhint": "之後新增的地點也會自動涵蓋",
			"scopeselected": "只追隨指定地點",
			"scopecount": "已選 {selected} / {total}",
			"scopeempty": "目前沒有可選的地點",
			"scoperequired": "請至少勾選一個地點",
			"venuecount": "共 {selected} / {total} 個地點",
			"notifyon": "通知已開啟（點擊關閉）",
			"notifyoff": "通知已關閉（點擊開啟）",
			"notifylabel": "開新場次時通知我",
			"modaltitleadd": "新增追隨",
			"modaltitleedit": "追隨設定",
			"hostlabel": "主辦單位",
			"targetlabel": "選擇主辦單位",
			"targetempty": "目前沒有可追隨的主辦單位",
			"targetemptynext": "在場次列表看得到別人的公開賽事之後，這裡就會出現對應的主辦單位。",
			"targetfollowed": "已追隨",
			"save": "儲存",
			"saved": "已儲存追隨設定",
			"saving": "儲存中…",
			...
			"cancel": "取消",
			"close": "關閉",
			"emptylist": "還沒有追隨任何主辦單位",
			"emptylistnext": "在場次頁點主辦單位旁的「追隨」，或用上面的「新增追隨」加入。",
			"loadfail": "追隨清單載入失敗",
			"retry": "重新載入"
		},
		"sessionlist": {
			...
			"printcolrank": "名次",
			"printcolprofit": "盈虧",
			"printtotalsession": "總場次",
			"printtotalprofit": "總盈虧",
			"printavglength": "平均時長",
			"printcount": "本次列印筆數",
			"printsectiontitle": "場次列表",
			"printempty": "查無場次",
			"printsignstaff": "承辦人簽名",
			"printsignmanager": "主管簽名",
			"printtitle": "場次列表",
			"printsubtitle": "賽事列表存底",
			"printmeta": "列印時間",
			"registering": "報名中...",
			"cancelling": "取消中...",
			"copying": "複製中...",
			...
			"onlyjoined": "有參與",
			"onlyfollowed": "追隨中",
			"emptyfollowed": "追隨的主辦單位目前沒有場次",
			"emptyfollowednext": "可能是還沒追隨任何主辦單位，或他們近期沒有開場。",
			"followmanage": "管理追隨清單",
			"followedmarktitle": "這場的主辦單位在你的追隨清單中",
		...
		"benefit": {
			"incompletedata": "資料量較大，目前只計入最新的 {loaded} 筆場次（共 {total} 筆）。上方所有數字都不包含更早的紀錄。",
			"title": "進階報表",
			"clubsectiontitle": "依協會分組",
			"clubsectiondesc": "依協會彙整同一查詢區間的淨盈虧。與上方趨勢圖採用相同的排除規則：你主辦的場次與你以工作人員身分參與的場次都不列入。",
			"clubheadname": "協會",
			"clubheadcount": "場次數",
			"clubheadprofit": "淨盈虧",
			"clubuncategorized": "未指定協會",
			"clubempty": "這個區間沒有可分組的資料",
			"clubemptydesc": "調整日期區間，或確認場次已設定所屬協會。",
			"startdate": "開始日期",
			"enddate": "結束日期",
			"search": "查詢",
			"reset": "重置",
		...
		"auth": {
			...
			"ERROR_user_banned": "此帳號已被封鎖或停權，無法繼續使用需要帳號權限的功能。",
			"ERROR_invalid_gametype_code": "遊戲類型代碼只能使用英文大寫與數字。",
			"ERROR_duplicate_gametype_code": "遊戲類型代碼已存在。",
			"ERROR_zz_required": "ZZ 是必要的其他類型，不能刪除。",
			"NETWORK_ERROR": "網路不佳，請檢查連線後再試一次",
		...
		"blockedpage": {
			"pagetitle": "帳號無法使用 - PokerTrace",
			"eyebrow": "Account notice",
			"title": "您的帳號目前無法使用",
			"message": "此帳號已被封鎖或停權，因此無法登入或使用需要帳號權限的功能。",
			"reviewtitle": "需要複查？",
			"reviewbody": "如果您認為此處有異議，請透過 Email 或聯絡我們頁面與我們聯絡。",
			"contact": "前往聯絡我們",
			"contactbutton": "聯絡我們",
			"homebutton": "回首頁"
		},
		...
		"indexpage": {
			...
			"feat9title": "手牌動畫回放",
			"feat9desc": "手牌詳情可用動畫重播整手牌，包含發牌、下注、攤牌、派彩與全押勝率。",
			"feat10title": "工具百寶箱",
			...
			"toolstructuregentitle": "結構產生器",
			"toolstructuregendesc": "即時盲注結構＋自動換籌＋匯出 JSON",
			"toolhandbooktitle": "撲克玩法手冊",
			"toolhandbookdesc": "德州、奧馬哈、抽牌與梭哈玩法速查",
			"toolfstitle": "翻後 GTO 求解器",
			"toolfsdesc": "自製 CFR 即時求解翻牌局面策略",
			"toolcstitle": "起始計分牌配置",
			"toolcsdesc": "依面額自動建議每人計分牌顆數",
		...
		"equitypage": {
			...
			"selectedrange": "已選組合",
			"norangeset": "尚未選擇範圍",
			"rangeplaceholder": "例如 AKs,AQo+,TT+,22-99,random",
			"rangehint": "空白時使用上方手牌；有填範圍時以範圍計算。",
			"rangecount": "組合",
			"rangesample": "樣本",
			"rangeerror": "範圍格式錯誤，或與公共牌 / 棄牌衝突",
			"rangeonlyholdem": "目前範圍計算只支援 2 張底牌牌型",
			"solvefail": "解算失敗，請稍後再試"
		},
		"timebankdrillpage": {
			"labelplaceholder": "例：決賽桌",
			"title": "Timebank 計時器",
			"back": "回上一頁",
			"presets": "時間情況設定",
			"seconds": "秒數",
		...
		"potoddspage": {
			"outsnote": "Outs = 能讓你成牌的剩餘張數。4/2 法則：翻牌看兩張用 Outs × 4、轉牌看一張用 Outs × 2，快速估算成牌勝率。",
			"title": "底池賠率",
			"back": "回上一頁",
			"pot": "目前底池",
			"call": "要跟的注",
		...
		"registerpage": {
			"seatoutofrange": "（超出座位數）",
			"tablenotfound": "（牌桌已刪除）",
			"batchtitle": "批次確認與排座",
			"batchhint": "先勾選要處理的選手，再批次確認或排座；排座僅對已確認選手生效。",
			"selectall": "全選",
			"batchconfirmbtn": "批次確認",
			"startchipplaceholder": "起始計分牌",
			"fillunseatedbtn": "未入座補位",
			"reseatselectedbtn": "重排選取選手",
			"balanceallbtn": "全部桌平均排座",
			"applybestchipbtn": "套用晉級最高計分牌",
			"filterplaceholder": "查詢名稱 / ID / 名次",
			"filterall": "全部",
			"filterpending": "待確認",
			"filterunseated": "未入座",
			"filteralive": "未淘汰",
			...
			"prevpage": "上一頁",
			"nextpage": "下一頁",
			"searchplayerbtn": "查詢選手",
			"sessionmax": "本場上限 ",
			"financefix": "修正",
			"autoprizehint": "空白代表使用自動獎金",
			"applyicm": "ICM 分配",
			"applyicmconfirm": "ICM 分配會依目前在場選手計分牌與獎金表，覆寫這些選手的獎金修正額。確定繼續？",
			"applyicmdone": "已完成 {n} 位選手的 ICM 分配",
			"helpconfirmlabel": "確認報名：",
			"helpconfirmtext": "把選手從「已報名」推進到可排座、可計入現場流程的狀態。",
			"helpseatlabel": "排座：",
			"helpseattext": "只對已確認選手生效，可補未入座、重排選取選手，或平均全場座位。",
			"helpadvancelabel": "晉級：",
			"helpadvancetext": "把選手帶往下一場目標賽事，並保存該選手的晉級計分牌。",
			"helpfinancelabel": "收益修正：",
			"helpfinancetext": "只改這筆報名的財務資料，不會回寫整個場次設定。",
			"helpregisteredtext": "選手送出報名，但還沒完成主辦確認。",
			"helpconfirmedtext": "可排座、可計入現場人數與後續操作。",
			"helpadvancedtext": "已轉入下一場目標賽事，若重複晉級會保留較高計分牌。",
			"helpcancelledtext": "這筆報名已失效；若已淘汰則需看再入額度是否仍可用。",
			"helpflow1": "先搜尋或新增選手，確認是不是要用現金 / 票券報名。",
			"helpflow2": "先批次確認，再做未入座補位或平均排座，避免座位混亂。",
			"helpflow3": "現場淘汰或多日賽時，再處理再入、晉級與收益修正。",
			"helpflow4": "每次批次操作後先看本頁摘要，再決定要不要繼續下一步。",
			"advancechiptitle": "設定晉級計分牌",
			"advancechipdesc": "系統會把選手帶到下一場多日賽；若選手重複晉級，下一場會保留最高計分牌。",
			"scanlink": "掃描 QR",
			"backtosession": "返回場次",
			"helpsummary": "操作說明 / 狀態說明 / 新手引導",
			"helpoperationtitle": "操作說明",
			"helpstatustitle": "狀態說明",
			"helpguidetitle": "新手引導",
			"helptoggle": "展開 / 收合",
			"heading": "報名清單",
			"listheading": "報名名單",
			"listnote": "點欄位排序、勾選後可批次操作；右側可匯出目前篩選結果。",
			"printlist": "列印名單",
			"colselect": "選取",
			"colfix": "修正",
			"colprofit": "收益",
			...
			"ticketvaluelabel": " / 票值 ",
			"financetitle": "修正報名資料",
			"financedesc": "這裡只修正此選手的報名財務資料，不會更改賽事本身設定。",
			"financereentry": "再入次數",
			"financerebuy": "重買 (Rebuy) 次數",
			"financeaddon": "增購 (Addon) 次數",
			"financeprize": "獎金修正",
			"financeticket": "票券價值",
			"financepayment": "買入方式",
			"paymentcashbuy": "現金買入",
			"paymentticketbuy": "票券買入",
			"save": "儲存",
			"register": "報名",
			"searchdesc": "可搜尋選手 ID、名稱或 Email。若是現場新選手，請先確認他是否已建立帳號。",
			"staffcannotregister": "員工不可報名",
			"nomatchplayer": "找不到符合的選手",
			"nomatchuser": "沒有符合的使用者",
			"addplayer": "加入選手",
			"searchplaceholder": "選手 ID / 名稱 / Email",
			"searchhint": "輸入選手 ID、名稱或 Email 查詢後加入，或對現場選手直接報名。",
			"testuser": "測試使用者",
			"confirm": "確認",
			"advance": "晉級",
			"eliminate": "淘汰",
			"updatechip": "更新計分牌",
			"printreceipt": "列印收據",
			"printprizereceipt": "列印獎金收據",
			"reentrymaxed": "再入已達上限",
			"reentryfail": "再入失敗",
			"seatafterconfirm": "確認後可排座",
			"bustedneedreentry": "已淘汰，請先再入",
			"tableseatchip": "桌次/座位/計分牌數",
			"advancedprefix": "晉級 ",
			"chipmid": " / 計分牌 ",
			"repeatadvanceprefix": "重複晉級 ",
			"repeatadvancemid": " 次 / 最高 ",
			"costlabel": "成本 ",
			"placelabel": "名次 ",
			"autoprizelabel": "自動獎金 ",
			"updatecurrentplaces": "更新目前名次",
			"saveplace": "儲存名次",
			"placeupdated": "目前名次已更新",
			"placesaved": "名次已儲存",
			"invalidplace": "請輸入正整數名次，或留空清除",
			"advancenoplace": "晉級不計名次",
			"printcolno": "序號",
			"printcolplayer": "選手",
			"printcolregtime": "報名時間",
			"printcolstatus": "狀態",
			"printcoltable": "桌次",
			"printcolseat": "座位",
			"printcolbuyin": "買入",
			...
			"printsession": "場次",
			"printtotalcount": "總筆數",
			"printtotalchip": "總計分牌數",
			"totalchipdifftitle": "與應有總量的差異。應有總量：",
			"printsectiontitle": "報名名單",
			"printsignstaff": "承辦人簽名",
			"printsignmanager": "主管簽名",
			"printtitlesuffix": " 報名名單",
			"printsubtitle": "報名清單存底",
			"printmeta": "列印時間",
			"panelregisterresult": "報名結果",
			"paneladded1": "已加入 1 位選手",
			"paneladdedmsg": "系統已將搜尋到的選手加入這場賽事，接下來可直接做確認或排座。",
			"labelsuccess": "成功",
			"labelfail": "失敗",
			"labelnext": "下一步",
			"valueconfirmseat": "確認 / 排座",
			"panelseatresult": "排座結果",
			"panelfilledtitle": "未入座選手已補位",
			"panelfilledmsg": "系統已依指定牌桌與起始計分牌處理未入座選手，請再檢查是否仍有人工調整需求。",
			"labelmode": "模式",
			"valuefillunseated": "未入座補位",
			"labeltable": "牌桌",
			"labelchip": "計分牌",
			"panelreseattitle": "已重排選取選手",
			"panelreseatmsg": "只針對目前勾選的已確認選手重新分配座位，其他選手資料不受影響。",
			"valuereseatselected": "重排選取選手",
			"panelbalancetitle": "已完成平均排座",
			"panelbalancemsg": "系統已嘗試平衡所有牌桌座位，請再檢查個別桌況是否需要微調。",
			"valuebalanceall": "平均全場",
			"labelstartchip": "起始計分牌",
			"valuechecktable": "檢查桌況",
			"panelbatchconfirm": "批次確認摘要",
			"panelbatchtitle": "批次確認已完成",
			"panelbatchmsg": "系統已完成這次批次確認。建議下一步直接檢查未入座選手，決定是否要補位或平均排座。",
			"valuefillseat": "補位 / 排座",
			"panelapplymax": "套用最高計分牌",
			"panelapplyoktitle": "已套用重複晉級最高計分牌",
			"panelapplyfailtitle": "部分選手套用失敗",
			"panelapplymsg": "系統已把重複晉級選手的起始計分牌更新為各自的最高晉級計分牌。",
			"panelseatsaved": "座位結果",
			"panelseatsavedtitle": "已儲存座位調整",
			"panelseatsavedmsg": "這位選手的牌桌、座位與起始計分牌已更新完成。",
			"labelplayer": "選手",
			"valuesingleseat": "單筆座位調整",
			"missingsessionid": "缺少 sessionid",
			"noseat": "未排座",
			"needadvancechip": "請輸入晉級計分牌",
			"multiadvancetarget": "此賽事有多個晉級目標，請先整理關聯設定",
			"paymentticket": "票券",
			"paymentcash": "現金",
			"prizeauto": "自動",
			"pageinfoprefix": "顯示 ",
			"pageinfomid": "，第 ",
			"pageinfosuffix": " 頁",
			"noregistration": "尚無報名紀錄",
			"nomatchregistration": "查無符合條件的報名紀錄",
			"confirmcancel": "確定要取消這位選手的報名嗎?",
			"eliminateconfirm": "確認淘汰這位選手？",
			"eliminatedone": "已標記淘汰",
			"advancedtoprefix": "已晉級到 ",
			"advancedcountmid": "，累計晉級 ",
			"advancedcountsuffix": " 次",
			"registrationnotfound": "找不到報名資料",
			"entrypending": "未確認",
			"needselectconfirm": "請先選取要確認的選手",
			"noduplicateadvance": "沒有重複晉級選手可套用最高計分牌",
			"confirmapplyprefix": "確定把 ",
			"confirmapplysuffix": " 位重複晉級選手的起始計分牌，套用為各自的最高晉級計分牌？",
			"edited": "修改完成",
			"statusregistered": "已報名",
			"statusconfirmed": "已確認",
			"statusadvanced": "已晉級",
			"statuscancelled": "已取消",
			"noprintdata": "目前沒有報名資料可列印",
			"needselecttable": "請先選擇牌桌",
			"needselectreseat": "請先選取要重排的選手",
		...
		"gtopage": {
			...
			"tree_title": "對戰樹",
			"tree_hint": "沿翻前順序選每位選手的動作；一旦有人全下，後面就改成跟注 / 棄牌。矩陣顯示「目前行動者」的範圍。點上方座位可直接跳到該位（前面全部蓋牌）。",
			...
			"grade_solved": "迭代求解",
			"grade_ref": "參考範圍",
			"emptynodetitle": "這條分支還沒有專屬範圍",
			"emptynodedesc": "不是你操作錯了。這裡通常是冷跟注、squeeze、cold 4bet，或大盲面對 limp 之後的多方分支；目前資料庫還沒有把這些低頻線完整算進來。",
			"emptynodehinttitle": "可以先用這些方式接近：",
			"emptynodehint1": "退回上一位行動者，看開池方、3bet 方或全下方的主要範圍。",
			"emptynodehint2": "如果有效計分牌偏短，切到「短碼全下」查同位置的 push/fold 參考。",
			"emptynodehint3": "如果是深碼多方池，把 RFI / 3bet 單挑範圍當保守基準，再把邊緣牌降權處理。",
			"fs_title": "翻後 GTO 求解器",
			...
			"fs_fslibtitle": "預先算好的策略庫",
			"fs_fslibopenerlabel": "開池方位置",
			"fs_fslibscenariolabel": "對位",
			"fs_fslibhint": "選位置對位、點翻牌選牌，選好會自動載入已經算好的策略，不用重新求解。",
			"fs_fslibempty": "這個環境沒有提供預先算好的策略庫。你可以改用下方「自己輸入範圍即時求解」直接算。",
			"fs_fslibfail": "讀取失敗",
			"fs_fslibnotready": "策略庫還沒有這組對位在這張翻牌的結果。你可以改用下方的即時求解。",
			"fs_thirdlabel": "背景選手範圍（多人池，選填，最多 7 家）",
			"fs_thirdplaceholder": "留空＝雙人求解；每填一格＝多一個背景選手（固定範圍、一般下注會跟、一被加注就當作蓋牌，非嚴謹多人均衡）",
			"fs_bgadd": "＋ 加一家",
			"fs_bgcount": "共 {n} 家（OOP＋IP＋{k} 個背景選手）",
			"fs_multiwaynote": "簡化多人模型：背景選手固定範圍、一般下注會跟、但一被加注就視為蓋牌；非嚴謹多人 Nash 均衡，僅供參考。",
			"fs_street_flop": "翻牌",
			"fs_street_turn": "轉牌",
			"fs_street_river": "河牌",
			"fs_deal_turn": "抽轉牌",
...
"handrankingpage": {
		...
		"chipcolorpage": {
			"title": "計分牌顏色對照",
			"back": "回上一頁",
			"note": "以下為業界常見的賭場現金桌配色慣例，不是你的個人設定；各場館與錦標賽用色可能不同，以現場公告為準。登入並在個人資料設定計分牌組合後，這裡會改為顯示你自己的牌組。",
			"profilenote": "以下為你在個人資料設定的計分牌組合。顏色名稱取自你的調色盤；若某個顏色不在調色盤中，會直接顯示色碼。"
		},
		"handsestpage": {
			"title": "每小時手數估算",
			"back": "回上一頁",
		...
		"adminuserpage": {
			"pagesizelabel": "每頁筆數",
			"permissionoutofrange": "（不在 Lv1~Lv5）",
			"tablog": "紀錄",
			"tabuser": "使用者",
		...
		"guidepage": {
			"title": "操作說明",
			"description": "PokerTrace 操作說明，涵蓋場次、報名座位、計時器、手牌紀錄、統計名次、系列賽、轉播回放、追隨主辦單位、聘用人員、現場報到與工具中心。",
			"heading": "操作說明",
			"lead": "這裡整理 PokerTrace 的完整操作流程。你可以依照現場角色與需求直接跳到對應段落：從建場、報名座位、計時器、手牌紀錄、統計名次，到系列賽、轉播回放、追隨主辦單位、聘用人員、現場報到收據與工具中心，都能快速找到操作重點。",
			"chapterlabel": "章節",
			"position": "定位本段",
			"copylink": "複製連結",
			"chapterlink": "章節連結",
			...
			"chapters": [
				...
				},
				{
					...
					"items": [
						...
						{
							"id": "player-follow-host",
							"title": "4. 追隨常打的主辦單位",
							"desc": "站上主辦單位很多，但你通常只固定跑其中幾家。追隨之後，場次列表可以用「追隨中」只看這幾家的賽事；他們發布新賽事時你也會收到通知，不必自己一直回來翻列表。同一個主辦單位有多個地點時，還可以只追其中幾個場館。",
							"steps": [
								"在場次列表點進任何一場別人主辦的賽事，主辦單位那一列右邊就有「追隨」。",
								"選擇「全部地點」或只勾選你會去的場館，確認要不要接收新場次通知後儲存。",
								"回到場次列表，按快速篩選的「追隨中」就只會顯示這些主辦單位的賽事。",
								"要改範圍、關通知或取消追隨，到個人資料的「追隨主辦單位」區塊調整。"
							],
							"tip": "追隨清單只有你看得到，主辦單位不會知道誰追隨他，也看不到人數。關掉通知不影響「追隨中」篩選，兩者是分開的。",
							"pageurl": "profile.html",
							"pagelabel": "前往追隨清單"
						}
					]
				...
				},
				{
					"id": "hand-replay",
					"title": "手牌動畫回放",
					"lead": "手牌詳情頁提供動畫回放，把整手牌從發牌到派彩逐步重演，適合賽後檢討與分享。",
					"items": [
						{
							"id": "hand-replay-playback",
							"title": "手牌動畫回放",
							...
							"tip": "回放牌背樣式可在個人偏好設定，全押勝率由後端即時計算。",
							"tools": [
								{
									"name": "時間軸",
					...
					"items": [
						...
						},
						{
							...
							"steps": [
								...
								"輸入對方的使用者 ID（例如 00000099）後點「新增」送出邀請。",
		...
		"tablepage": {
			...
			"player": "選手",
			"blind": "盲注",
			"handrecordnote": "可用下方條件篩選紀錄；新增手牌會承接目前碼量，計分牌校正用於現場點數修正。",
			"statsnote": "彙整本桌手牌的勝負、買入與淨額，數字會隨手牌紀錄即時更新。",
			"hand": "手牌",
			"result": "結果",
			"createinfo": "建立資訊",
			"action": "操作",
		...
		"newtablepage": {
			...
			"labelno": "牌桌編號",
			"submit": "送出",
			"note": "填入單一編號，或以起始與結束編號一次建立多個牌桌。",
			"labelstartno": "起始牌桌編號",
			"labelendno": "結束牌桌編號",
			"rangenote": "填入起始與結束編號可一次建立多個牌桌，例如 1 到 9 會建立 9 個牌桌。只填其中一個範圍欄位時，只會建立該編號。",
		...
		"tableboardpage": {
			...
			"eliminatebutton": "淘汰",
			"movetitle": "移動選手",
			"movedesc": "選擇要把「{player}」移到哪張牌桌與座位，或交給系統隨機安排。",
			"moverandom": "隨機安排",
			"moveempty": "沒有可移入且有空位的牌桌",
			"movesuccess": "已移動選手",
			"movefail": "移桌失敗",
			"eliminateconfirm": "確定要淘汰「{player}」嗎？",
			"eliminatesuccess": "已淘汰選手",
			"eliminatefail": "淘汰失敗"
		},
		"tablemanage": {
			"sectiontitle": "牌桌管理",
		...
		"newedithandpage": {
			"boardrun": "第 {n} 次",
			"runboardpot": "獎池 {amount}",
			"runboardadd": "＋ 再發一次",
			"runboardremove": "移除",
			"chipunit": "計分牌",
			"feltsitin": "入座",
			"felthint": "點空位加入選手・點選手可改碼量與設定・下方按鍵記錄動作（可移除復原）",
			"allocation": "分配",
			"navindex": "首頁",
			"navprofile": "個人資料",
			"navclub": "協會管理",
			...
			"step3": "3 檢查送出",
			"step1title": "位置與盲注",
			"step1descedit": "先確認遊戲類型、盲注與 Dealer，再進下一步",
			"step1descquick": "快速紀錄為獨立手牌，可自由設定遊戲類型、盲注與座位",
			"editlocktitle": "舊手牌部分鎖定",
			"editlockdesc": "這不是本桌最新手牌，為避免影響後續起始計分牌，位置、盲注、下注與結果已鎖定；仍可修改手牌、公共牌與備註。",
			"editlocktoast": "舊手牌只能修改手牌、公共牌與備註；位置、盲注、下注與結果已鎖定。",
			"blindlevellabel": "盲注級別",
			"emptybutton": "空 button",
			"deadsmallblind": "獨立大盲",
			"rebuildblinds": "重建預設下注",
			"seathintedit": "點座位可標記選手與起始碼量",
			"seathintquick": "自行選擇入座的座位並輸入起始碼量（可用 BB 或計分牌）",
			"step2title": "紀錄手牌",
			"step2desc": "選擇要操作的項目，現場一步一步點",
			"hubherocards": "新增我的手牌",
			"hubbetting": "下注管理",
			"hubshowdown": "攤牌 / 結果",
			"hubresultinfo": "選牌・選贏家",
			"bettingtitle": "下注管理",
			"backtohub": "回上頁",
			"timebankstart": "開始",
			"timebankpause": "暫停",
			"timebankreset": "重設",
			"waitingnext": "等待系統推算下一位",
			"showdowntitle": "攤牌 / 結果",
			"solvewinner": "快速解算",
			"step3title": "儲存前檢查",
			"step3desc": "送出前先看警告，黃色為提醒、紅色需修正",
			"step3noteedit": "送出後下一手會承接結束碼量",
			"step3notequick": "快速手牌為獨立紀錄，不與其他手牌連動，日後可自由編輯",
			"psplaceholderedit": "現場補充、裁定或不連貫原因",
			"psplaceholderquick": "現場補充、裁定或其他說明",
			"saveandnext": "送出，並新增下手牌",
			"summarytitle": "摘要",
			"labelnote": "備註",
			"labelseat": "牌桌",
			"labelplayer": "選手",
			...
			"cancel": "取消",
			"confirm": "確認",
			"boardeditortitle": "公共牌",
			"tapeditcard": "點選要編輯的牌",
			"raiseinvested": "已投入 ",
			"raisecalltarget": "，目前跟注到 ",
			"raiseremain": "，剩餘 ",
			"raiseminchip": "，最小計分牌 ",
			"betraiseto": "下注 / 加注到",
			"keyclear": "清除",
			...
			"editplayer": "編輯選手",
			"sitin": "入座",
			"feltdesc": "邊記邊設定，不必回牌桌頁。",
			"tabname": "輸入名字",
			"tabaccount": "搜尋帳號",
			"nameplaceholder": "例：黑衣哥、光頭",
			"acctplaceholder": "輸入名字或選手 ID…",
			"startstack": "起始碼量",
			"update": "更新",
			"addseat": "加入座位",
			"searchnotfound": "找不到，改用「輸入名字」。",
			"boundaccount": " · 已綁帳號",
			"tempname": " · 臨時名字",
			"menurename": "✎ 改名 / 綁定帳號",
			"menuhero": "⭐ 設為 Hero",
			"menudealer": "🔘 設為 Dealer",
			"menuunknown": "❓ 標記未知碼量",
			"menuvacate": "✕ 離座",
			"customlevel": "自填",
			"removeaction": "移除",
			...
			"hubremain": "剩餘選手",
			"hubnext": "下一位",
			"msgfoldedprefix": "其他選手都已蓋牌，只剩 ",
			"msgfoldedsuffix": "，手牌已結束。",
			"msgallfolded": "所有選手都已蓋牌，請檢查手牌結果。",
			"msgstreetdoneprefix": "本輪都已跟注 / 過牌，請切換到",
			"msgstreetdonesuffix": "。",
			"unsupported": "（未支援）",
			"blindlabel": "盲注",
			"bringinlabel": "帶入注",
			...
			"summaryseat": "有效選手：",
			"summarypot": "人<br>總底池：",
			"summaryreward": "<br>收益底池：",
			"summarywinner": "<br>贏家數：",
			"summaryalloc": "<br>已分配：",
			...
			"heroseat": "Hero 座位",
			"herocards": "Hero 手牌",
			"showcardmodal": " show 牌",
			"statusloading": "載入中...",
			"statusnotupdated": "尚未更新",
			"statusnotsaved": "尚未儲存",
			"bringin": "帶入注",
			"smallblind": "小盲",
			"noselect": "未選",
			"streetfinished": "本街已結束",
			"acting": " 行動中",
			"boardtitle": "公共牌",
			"dealtitle": "發牌",
			"drawtitle": "換牌",
			"toastpublicnohero": "公共紀錄不指定 Hero，請改在攤牌補各家牌",
			"toastnoseat": "找不到可操作座位",
			"raiserestricted": "目前下注未達完整加注，這位選手只能跟注或蓋牌",
			"toastminchipadjust": "已依最小計分牌調整為 ",
			"toastnoseatnow": "目前沒有可操作座位",
			"toastloading": "資料載入中",
			"toastforcesubmit": "有提醒事項，再點一次送出可強制儲存",
			"toastupdated": "已更新",
			"toastsaved": "已儲存",
			"toastwinnerapplied": "已套用建議贏家",
			"toastwinnerappliedsplit": "已套用建議贏家（高低分池：低池金額已分給合格低牌）",
			"toastnotenoughshow": "沒有足夠 show 牌可解算",
			"confirmquicksolve": "快速解算會覆蓋目前手動設定的贏家與分配金額，確定要繼續嗎？",
			"toastneedboard": "請先補齊公共牌（翻牌、轉牌、河牌）再解算",
			"confirmcleartemp": "確定清空暫存？",
			"confirmswitchfamily": "切換遊戲家族會清空已輸入的下注動作與換牌 / 發牌紀錄，確定要切換嗎？",
			"confirmcleartable": "清空本桌尚未送出的暫存手牌資料？此動作無法復原。",
			"toasttempcleared": "已清空暫存",
			"streetflop": "翻牌",
			"streetturn": "轉牌",
			"streetriver": "河牌",
			"burnflop": "燒牌（翻牌）",
			"burnturn": "燒牌（轉牌）",
			"burnriver": "燒牌（河牌）",
			"warnfewseat": "有效選手少於 2 人。",
			"warnbusted": "計分牌歸 0，送出後將自動淘汰該選手，不需再由裁判處理。",
			"warnheroincomplete": "Hero 手牌尚未選完整。",
			"warnnowinner": "尚未選擇贏家。",
			"warnnopot": "下注紀錄目前沒有任何底池。",
			"warnpotprefix": "總底池不是最小計分牌 ",
			"warnmultiplesuffix": " 的倍數。",
			"warnnegativestack": " 結束碼量小於 0。",
			"warnallocprefix": " 分配金額不是最小計分牌 ",
			"warnallinprefix": "有選手 all-in 攤牌，但「",
			"warnallinburnmid": "」未填、卻已填「",
			"warnallinburnsuffix": ")，是否誤把公共牌點成燒牌？",
			"warnallinmissingsuffix": "」尚未填，請確認牌面是否完整。",
			"checkpass": "檢查通過，可以送出。",
			"selectedcard1": "公共",
			"selectedcard2": "紀錄",
			"burn": "燒 ",
			"noactionseat": "目前沒有可操作座位",
			"actionmeta": "已投入 {put}，需跟注 {call}",
			"showorderhint": "建議 {seat} 先 show；現場可選擇其他選手 show 或 muck。",
			"updatefailed": "更新失敗",
			"savefailed": "儲存失敗",
		},
		"stackadjustpage": {
			"pagetitle": "編輯計分牌校正",
			"lockednote": "這不是最新一筆紀錄，計分牌已鎖定，只能修改備註",
			"playercount": "{n} 人",
			"nowlabel": "目前",
			"afterlabel": "校正後",
			"warnnoadjust": "尚未填寫任何計分牌增減。",
			"warnnonote": "請填寫備註。",
			"heading": "計分牌校正",
			"back": "上一頁",
			"labeltable": "牌桌",
			...
			"totalstack": "場上總碼量",
			"reasontitle": "校正原因",
			"reasonnote": "這會建立一筆紀錄，下一手會承接校正後碼量",
			"reasoncount": "現場點數校正",
			"reasonrace": "換色 / Race off",
			"reasonpenalty": "罰碼 / 補碼",
			"reasonseat": "座位資料修正",
			"psplaceholder": "請記錄校正原因",
			"adjusttitle": "碼量增減",
			"adjustnote": "填入每位選手本次增減量",
			"saveadjust": "儲存校正",
			"cansave": "可以儲存。",
			"saving": "儲存中...",
			"loading": "載入中...",
			...
			"updated": "已更新校正",
			"saved": "已儲存校正",
			"loadtablefailed": "讀取牌桌失敗",
			"loadrecordfailed": "讀取紀錄失敗",
			"notadjustrecord": "這不是計分牌校正紀錄",
			"noteonlystatus": "非最新紀錄，僅可改備註",
			"notupdated": "尚未更新",
		},
		"newsessionpage": {
			"modehosted": "主辦牌局",
			"modepersonal": "個人成績補登",
			"modenone": "尚未選擇",
			"hintstart": "選完模式後，從基本資料開始往下填。",
			"hintstep1": "先確認這場的基本資料與時間。",
			"hintstep2hosted": "先決定再購、再入與報名規則。",
			"hintstep2personal": "先標記你這次是否再入場，以及是否進 ITM / Final Table。",
			"hintstep3hosted": "把費用與計分牌補齊，並確認下方進階設定與備註，即可建立場次。",
			"hintstep3personal": "把你的實際支出與結果補齊，並確認進階設定，之後統計會更準。",
			"switchmodeconfirm": "切換模式後會保留共用欄位，但你應重新確認後續規則與費用設定。要切換嗎？",
			"needmode": "請先選擇主辦牌局或個人成績補登",
			"negativesuffix": "不得為負數",
			"labelbuyin": "買入費",
			"labelbuyinfee": "買入服務費",
			"labelchip": "起始計分牌",
			"labelrebuycount": "Rebuy 次數",
			"labelrebuybuyin": "Rebuy 費用",
			"labelrebuyfee": "Rebuy 服務費",
			"labelrebuychip": "Rebuy 計分牌",
			"labelreentrycount": "Reentry 次數",
			"labelreentrybuyin": "Reentry 費用",
			"labelreentryfee": "Reentry 服務費",
			"labelreentrychip": "Reentry 計分牌",
			"labeladdoncount": "Addon 次數",
			"labeladdonbuyin": "Addon 費用",
			"labeladdonfee": "Addon 服務費",
			"labeladdonchip": "Addon 計分牌",
			"labelguaranteedprize": "保底獎金",
			"labelpersonalreentrycount": "個人再入次數",
			"labelpersonalreentrybuyin": "再入費",
			"labelpersonalreentryfee": "再入服務費",
			"labelwinprice": "獎金金額",
			"labeltotalbuyin": "總買入",
			"labelplace": "名次",
			"labelunknown": "欄位",
			...
			"heading": "新增場次",
			"guidekicker": "對應操作說明",
			"guidenote": "主辦建場請看主辦版快速上手；若只是補登自己的成績，可直接看選手版補登段落。",
			"guidehostlink": "主辦建場說明",
			"guideplayerlink": "選手補登說明",
			"modehostedtitle": "我要建立一場可管理的牌局",
			"modehosteddesc": "適合主辦者，要設定買入、再購、報名與選手規則。",
			"modepersonaltitle": "我要補登這次參賽結果",
			"modepersonaldesc": "適合選手個人紀錄，不顯示主辦專用設定。",
			"modecurrent": "目前模式",
			"changemode": "重新選擇",
			"sectionbasic": "基本資料",
			"sectionregister": "報名與規則",
			"sectionfee": "費用與進階",
			"sectionadvanced": "進階設定",
			"aititle": "⚡ AI 匯入賽事",
			"aidesc": "貼上其他網站的賽事頁，自動填入名稱／起始計分牌／買入／開始時間與賽程結構",
			"aiplaceholder": "把整段賽事資訊貼進來，例如從賽事頁複製的內容…",
			"aibutton": "解析並填入",
			"step1title": "步驟 1. 基本資料",
			"step1kicker": "從這裡開始填",
			"labelgamemode": "牌局型態",
			"gamemodenote": "這會影響後續場次分類與摘要呈現。",
			"labelname": "場次名稱",
			"nameplaceholder": "例如：週五深籌賞金賽",
			"namenote": "建議讓選手一眼看懂時間或特色。",
			"labelvenue": "地點",
			"venuenote": "若還沒有場地，先到場地 / 協會頁建立。",
			"labelstartdate": "開始日期",
			"labelstarttime": "開始時間",
			"labelendtime": "結束時間",
			"step2title": "步驟 2. 報名與選手規則",
			"step2kicker": "依模式調整",
			"step2hostedtitle": "主辦牌局會保留完整規則",
			"step2hosteddesc": "先決定選手是否可報名與是否有再購 / 再入 / 增購次數，再到下一步補上金額與計分牌。",
			"rebuyexplain": "Rebuy：淘汰前可再買入，通常維持同一場內身份。",
			"reentryexplain": "Reentry：淘汰後重新入場，等於重新取得參賽資格。",
			"addonexplain": "Addon：固定時機追加計分牌，通常不需要先淘汰。",
			"labellinkuser": "使用者連結",
			"linkusernote": "讓選手能在系統內看到這場並與帳號關聯。",
			"labelopenregistration": "開放報名",
			"openregistrationnote": "選手可從場次列表直接報名，需先開啟使用者連結。",
			"labelprivate": "私人牌局",
			"privatenote": "限制可見性，仍建議先確認邀請流程。",
			"step2personaltitle": "個人成績補登只保留你的參賽資訊",
			"step2personaldesc": "這不是主辦設定頁，第二步只處理這次是否再入場，以及是否進錢圈 / Final Table。",
			"personalreentrynote": "若你中途淘汰後重新進場，請填入實際次數。",
			"labelitm": "有進錢圈 (ITM)",
			"itmnote": "若本場有進入獎勵圈，可先在這裡標記。",
			"labelft": "有進 Final Table",
			"ftnote": "若你有進決賽桌，這裡一起補登。",
			"step3title": "步驟 3. 費用與進階",
			"step3kicker": "請特別留意金額與次數的對應",
			"rebuynote": "淘汰前再次買入，常用於保留同一場內排名或參賽身分。",
			"reentrynote": "淘汰後重新報到，等於重新入場，費用與計分牌可獨立設定。",
			"addonnote": "固定時點追加計分牌，不需要先淘汰，常見於休息前後。",
			"rebuysection": "Rebuy 設定",
			"reentrysection": "Reentry 設定",
			"addonsection": "Addon 設定",
			"guaranteenote": "如無保底可維持 0。",
			"step3personaltitle": "補登你的實際支出與結果",
			"step3personaldesc": "若有再入場，請把再入次數和費用填完整，方便之後統計總買入與收益。",
			"labelprize": "獎品",
			"prizeplaceholder": "如無獎品可留空",
			"step4title": "進階設定（選填）",
			"step4kicker": "可維持預設值後續再調整",
			"labeleventtype": "賽事類型",
			"labelgametype": "遊戲類型",
			"labellimittype": "限注類型",
			"labelchiptype": "計分牌類型",
			"labelnote": "備註",
			"descriptionplaceholder": "可補充這場的特色、活動名稱、盲注說明或你想記住的內容",
			"descriptionnote": "這裡適合補充外部資訊，不必把規則都塞進場次名稱。",
			"submit": "建立場次",
			"needclub": "請選擇地點",
			"needdate": "請選擇開始日期",
			"needstarttime": "請選擇開始時間",
			"needendtime": "請選擇結束時間",
			"endtimebeforestart": "結束時間必須晚於開始時間",
			"needrebuyfee": "已設定 Rebuy 次數，請補齊 Rebuy 費用",
			"needreentryfee": "已設定 Reentry 次數，請補齊 Reentry 費用",
			"needreentrychip": "已設定 Reentry 次數，請補齊 Reentry 計分牌",
			"needaddonfee": "已設定 Addon 次數，請補齊 Addon 費用",
			"needaddonchip": "已設定 Addon 次數，請補齊 Addon 計分牌",
			"needpersonalreentryfee": "已設定個人再入次數，請補齊再入費",
			"previewname": "名稱：",
			"previewchip": "起始計分牌：",
			"previewbuyin": "買入：",
			"previewstarttime": "開始時間：",
			"previewderived": "（由報名截止時間回推）",
			"previewregclose": "報名截止時間 ",
			"previewregclosefail": "：無法回推開始時間（來源未標示報名截止級別），請自行填寫",
			"previewstructure": "賽程結構：",
			"previewlevelunit": " 級 + ",
			"previewbreakunit": " 個休息",
			"previewregcloselevel": "，報名截止 L",
			"aineedtext": "請先貼上賽事內容",
			"aiwait1": "AI 解析中…",
			"aiwait2": "AI 正在思考…",
			"aiwait3": "AI 正在整理賽程結構…",
			"aiwait4": "就快好了，請稍候…",
			"aiwait5": "內容較長，AI 仍在努力，請再等一下…",
			"aiparsefail": "解析失敗，請再試一次",
			"airuleonlyprefix": "AI 未啟用，僅用規則解析結構（",
			"airuleonlysuffix": " 項）",
			"aifilledprefix": "已填入欄位，並帶入 ",
			"aifilledsuffix": " 個賽程項目（建立場次後自動套用）",
			"aifilledonly": "已填入欄位",
			"aitimeout": "AI 解析逾時，請縮短內容或稍後再試",
			"ainetworkfail": "網路不佳，請重新嘗試",
			"selectclubplaceholder": "請選擇地點",
			"creating": "建立中...",
			"createsuccess": "新增成功",
			"backtolistcheck": "請回列表確認",
			"timeouttoast": "連線逾時，場次可能已建立，請先回場次列表確認",
			"timeoutwarn": "連線逾時，場次可能已建立，請先回場次列表確認，不要重複送出。",
		},
		"controlpage": {
			"brandtitle": "大螢幕品牌",
			"brandname": "品牌名稱",
			...
			"brandreload": "↺ 重新讀取",
			"brandsave": "儲存並套用",
			"brandhint": "只影響本場次的大螢幕。留空代表沒有設定，大螢幕維持預設外觀。儲存後大螢幕會在下一次同步時更新。",
			"brandsaved": "大螢幕品牌已更新",
			"brandreloaded": "已重新讀取",
			"brandsavefailed": "儲存失敗，請確認權限或稍後重試",
			"brandaction": "改大螢幕品牌",
			"brandcolordefault": "未設定主色時使用內建的綠色。",
			"brandcolorlow": "對比不足，大螢幕上會看不清楚",
			"brandcolormid": "對比偏低，遠處觀看可能吃力",
			"brandcolorok": "對比良好",
			"title": "裁判控制台",
			"heading": "賽事控制台",
			"back": "返回上頁",
	...
	"en": {
		"scanpage": {
			"heading": "Scan check-in QR",
			"desc": "Point the camera at the QR code on the player's receipt; the check-in page opens automatically.",
		...
		"checkinpage": {
			"backregister": "Back to Registration Desk",
			"backsessionlist": "Session List",
			"advancefollowed": "This receipt is the check-in proof for 「{from}」. The player has advanced; 「{current}」 is shown below.",
			...
			"printprize": "Print Prize Receipt",
			"player": "Player",
			"entryno": "Entry No.",
			"table": "Table",
			"seat": "Seat",
		...
		"staffworkpage": {
			"title": "Staff hours",
			"subtitle": "Clocked hours and payable amounts for scorekeepers, floor staff and assistants. Billing rounds up to 30-minute units.",
			"tabreport": "Across sessions",
			"tabsession": "Single session",
			"startdate": "From",
			"enddate": "To",
			"groupby": "Group by",
			"groupstaff": "By staff",
			"groupsession": "By session",
			"grouplog": "Every entry",
			"viewmode": "View as",
			"viewowner": "Staff I hired",
			"viewself": "My own hours",
			"search": "Search",
			"clear": "Clear filters",
			"cardminute": "Total time on this page",
			"cardamount": "Total amount on this page",
			"cardopened": "In progress",
			...
			"colamount": "Amount",
			"collogcount": "Entries",
			"colopened": "In progress",
			"colfirst": "Earliest",
			"collast": "Latest",
			"coloperator": "Recorded by",
			"running": "In progress",
			"crossday": "over a day",
			"selfmark": "self-recorded",
			"summarytitle": "Per-staff subtotal",
			"grandtotal": "Session total",
			"loadfail": "Failed to load",
			"emptyall": "No work records yet",
			"emptyallnext": "Clock a staff member in from the Staff tab of a session and entries will show up here.",
			"emptysearch": "No work records in this date range",
			"emptysession": "No work records for this session yet",
			"emptysessionnext": "Clock a staff member in from the Staff tab of the session.",
			"backfill": "Backfill clock-out",
			"backfillneedtime": "Pick a clock-out time first",
			"backfillok": "Clock-out backfilled",
			"backfillfail": "Backfill failed"
		},
		"staffwork": {
			"roledealer": "Scorekeeper",
			"rolefloor": "Floor",
			"roleassistant": "Assistant",
			"hour": "h",
			"minute": "m",
			"day": "d",
			"crossday": "running for ",
			"statuson": "On shift",
			...
			"shiftstart": "Clock in",
			"shiftbreak": "Break",
			"shiftresume": "End break",
			"shiftend": "Clock out",
			"startstaffshiftok": "Clocked in",
			"breakstaffshiftok": "Break started",
			"resumestaffshiftok": "Break ended",
			"endstaffshiftok": "Clocked out",
			"shiftok": "Updated",
			"shiftfail": "Action failed",
			"shiftloadfail": "Failed to load shift status",
			"stateoff": "Off",
			"stateworking": "Working",
			"stateonbreak": "On break",
			"attable": "Current table",
			"shifttotal": "This shift",
			"segmentcount": " segments",
			"loadfail": "Failed to load",
			"colstaff": "Staff",
			"colrole": "Role",
			"colstatus": "Status",
			"coltable": "Current table",
			"colduration": "Total time",
			"colrate": "Rate",
			"colamount": "Amount",
			"cardtotalminute": "Session total time",
			"cardtotalamount": "Session total amount",
			"cardworking": "On shift",
			"emptystaff": "No staff available for this session",
			"emptystaffnext": "Hire a scorekeeper, floor or assistant from your profile first, or assign someone to this session.",
			"emptystaffgoprofile": "Go to profile to hire",
			"paneltitle": "Staff overview",
			"filterall": "All",
			"filterworking": "On duty",
			"filteridle": "Idle",
			"filterontable": "At table",
			"filteronbreak": "On break",
			"filteroff": "Not clocked in",
			"filterempty": "No staff match this filter",
			"searchplaceholder": "Search name or ID",
			"colname": "Name",
			"colstate": "Status",
			"picktablehint": "Assign from a table card",
			"pendingonly": "Assigned, waiting for confirmation",
			"pendingonlynext": "They will appear in the roster once they open the link in the invitation email.",
			"pendingtitle": "Pending invitations",
			"pendinghint": "Until confirmed they will not appear in the roster and cannot clock in or take a table.",
			"pendingbadge": "Pending",
			"pendingsourcesession": "This session",
			"pendingsourceglobal": "Long-term",
			"billinghint": "Billing rounds up to 30-minute units; open shifts are not billed.",
			"assigntitle": "Assign staff to this session",
			"assignhint": "Applies to this session only. For long-term hires, use your profile.",
			"assignplayerid": "Player code",
			"assignbutton": "Assign",
			"assignok": "Assigned",
			"assignfail": "Assignment failed",
			"assignneedplayerid": "Enter a player code",
			"removesession": "Remove",
			"removeconfirm": "Remove this staff member from the session?",
			"removeok": "Removed",
			"removefail": "Removal failed",
			"leavetable": "Leave",
			"leaveok": "Left the table",
			"leavefail": "Failed to leave",
			"nostaff": "Unassigned",
			"me": "me",
			"sithere": "Sit at this table",
			"picktable": "Pick a table",
			"assigntable": "Assign duty",
			"assigntitle2": "Assign on-duty staff",
			"assigndesc": "Pick a staff member for this table. Anyone already at another table is moved over; anyone not clocked in is clocked in automatically.",
			"assignok2": "Assigned to table",
			"assignokclock": "Assigned, and clocked in automatically",
			"assignfail2": "Assignment failed",
			"noassignable": "No staff available to assign",
			"stateidle": "idle",
			"stateontable": "at ",
			"statenoclock": "not clocked in",
			"overlapwarn": "This table already has someone in that role; both are now on duty (handover).",
			"ratesession": "session override",
			"rateglobal": "global default",
			"ratesave": "Save",
			"rateok": "Rate updated; it only affects future clock-ins",
			"ratefail": "Update failed"
		},
		"sessionpage": {
			"boardrun": "Run {n}",
			"colornotinpalette": " (not in palette)",
			"printsessionname": "Session Name",
			"printcode": "Code",
			"printdate": "Date",
			"printreentryfee": "Re-entry Count / Cost",
			"printrebuyfee": "Rebuy Count / Cost",
			"printaddonfee": "Add-on Count / Cost",
			"printsessionended": "Session Ended",
			"tplimportprefix": "Import ",
			"tplcolumnorderhint": "Column order only applies to screens wider than 900px. Phones and tablets use a separate stacked layout with no three columns to reorder.",
			"tpldisplaysettinghint": "These settings only affect this session's display.html big screen. Blank fields mean no setting, so the big screen keeps its default look.",
			"tpllogourlhint": "Only http/https URLs are accepted. The big screen caps the height at 34px, so use a wide image with a transparent background.",
			"tplquickentryhint": "The actions this role uses most are gathered here to avoid overloading the page.",
			"tplnoseathint": "Your seat has not been assigned yet. If you have registered, wait for the host to confirm and seat you.",
			"tpldeletehint": "After deletion this event no longer appears in the list.",
			"tplchipsethint": "You can set your usual chip sets in your profile",
			"tplnolinkedplayer": "Linked players are not enabled for this session.",
			"tplnomatchlinked": "No linked players match the filter.",
			"tplnolinkedplayernow": "No linked players yet.",
			"tplnomatchplayer": "No players match the filter.",
			"tplnohandpermission": "You do not have permission to view hands",
			"tplnopayout": "No payout settings yet.",
			"tplnorelation": "No events available to link",
			"tplregisteredwait": "You have registered; waiting for the host to confirm.",
			"tplbadgeregistered": "⏳ Registered, waiting for confirmation",
			"tplbadgeconfirmed": "✅ Confirmed",
			"tplsessionloading": "Loading session data...",
			"tplserieslodaing": "Loading event data...",
			"tpltablesearcherror": "An error occurred while searching tables",
			"tplnotable": "No tables found",
			"tplsearchseries": "Search event name / token",
			"tplsearchplayerfull": "Search player / ID / seat / place",
			"tplsearchplayertable": "Search player name / ID / table",
			"tpltablenoplaceholder": "Table number",
			"tplregisterthis": "Register for This Session",
			"tplreregister": "Re-register / Re-entry",
			"tplunregister": "Cancel Registration",
			"tpldeletealltable": "Delete All Tables",
			"tplsavemultiday": "Save Multi-day Link",
			"tplsavesatellite": "Save Satellite Link",
			"tpladdchiprow": "Add Chip",
			"tpldeletesession": "Delete Event",
			"tplsavegamesetting": "Save Game Settings",
			"tplsavegeneralsetting": "Save General Settings",
			"tpltimerconsole": "🎛️ Timer Console",
			"tplregisterlist": "👥 Registration List",
			"tplcheckin": "✅ Check-in",
			"tplmycheckin": "✅ My check-in",
			"tpldisplaypage": "📺 Display (new tab)",
			"tplbrandname": "Brand / Club Name",
			"tpllogourl": "Logo image URL",
			"tplblockstoshow": "Blocks to Show",
			"tplcolumnorder": "Column Order",
			"tplshowtimer": "Show Timer",
			"tplbigscreen": "Big Screen Display",
			"tplaccentcolor": "Accent Colour",
			"tplallinhands": "All-in Hands",
			"tploriginalprize": "/ original pool",
			"tplsuggestnext": "Suggested Next Step",
			"tplyourrole": "Your Role",
			"tplwhatnext": "What to do next",
			"tplquickentry": "Quick Links",
			"tplfocusnow": "Look at these first",
			"tplmyseat": "My Seat",
			"tplmodifystructure": "Edit Structure",
			"tplviewstructure": "View Structure",
			"tpladdtable": "Add Table",
			"tplhostgame": "Hosted Game",
			"tplgeneral": "General",
			"tplgamesetting": "Game Settings",
			"tplseriesrelation": "Event Links",
			"tplmultidayrelation": "Multi-day Link",
			"tplsatelliterelation": "Satellite Link",
			"tplmultiday": "Multi-day",
			"tplsatellite": "Satellite",
			"tplplayerstatusprize": "Player Status & Prizes",
			"tplusechipdenom": "Use Chip Denominations",
			"tplchiptype": "Chip Type",
			"tplround": "Round",
			"tplsquare": "Square",
			"tplautostartbytime": "Auto-start by time",
			"tplallowticket": "Allow ticket buy-in",
			"tplunifiedhand": "Unified hand records",
			"tplprivategame": "Private game",
			"tplopenregistration": "Open registration",
			"tpllinkuser": "User link",
			"tplmaxseatcount": "Seats per table",
			"tpllimittype": "Limit Type",
			"tplgametype": "Game Type",
			"tpleventdetail": "Event Detail",
			"tplstartdate": "Start Date",
			"tplstarttime": "Start Time",
			"tplendtime": "End Time",
			"tplvenue": "Venue",
			"tplname": "Name",
			"tplnote": "Note",
			"tplticketvalue": "Ticket Value",
			"tplguaranteed": "Guaranteed Prize",
			"tplstartchip": "Starting Chips",
			"tplbuyinfee": "Buy-in Fee",
			"tplbuyinchip": "Buy-in Chips",
			"tplbuyincost": "Buy-in Cost",
			"tplrebuyfee": "Rebuy Fee",
			"tplrebuychip": "Rebuy Chips",
			"tplrebuycost": "Rebuy Cost",
			"tplreentryfee": "Re-entry Fee",
			"tplreentrychip": "Re-entry Chips",
			"tplreentrycost": "Re-entry Cost",
			"tpladdonfee": "Add-on Fee",
			"tpladdonchip": "Add-on Chips",
			"tpladdoncost": "Add-on Cost",
			"tplminchip": "Min Chip",
			"tplmaxchip": "Max Chip",
			"tplavgchip": "Avg Stack",
			"tplcumulativechip": "Cumulative Chips",
			"tplmaxwin": "Biggest Win",
			"tplmaxlose": "Biggest Loss",
			"tpltotalhands": "Total Hands",
			"tpltotalprize": "Total Prize",
			"tplwinrate": "Win Rate",
			"tplnetprofit": "Net Profit",
			"tplaverage": "Average",
			"tplcurrent": "Current",
			"tplcount": "Count",
			"tplprize": "Prize",
			"tplbusted": "Busted",
			"tplplayercount": "players",
			"tpltableslash": "tables /",
			"tplseatpos": "Seat",
			"tplseat": "Seat",
			"tplplayer": "Player",
			"tabtable": "Tables",
			...
			"tableboardentry": "Table Board",
			"colaction": "Actions",
			"colstarthand": "Starting Cards",
			"colimportance": "Importance",
			"handrecordtitle": "Hand Records",
			"statstitle": "Stats",
			"printsession": "Print session",
			"printhand": "Print hands",
			"venuesearchlabel": "Search table venue",
			"handsearchplaceholder": "Search table / player / seat",
			"handsearchlabel": "Search by table, player or seat",
			"handfromlabel": "Hand start date",
			"handtolabel": "Hand end date",
			"handseatlabel": "Seat filter",
			"chartstacktitle": "Cumulative chip stack chart",
			"chartstacknote": "Across every table in this session. Oldest hands on the left, newest on the right; each value is the stack after that hand.",
			"chartprofit": "Profit & Loss",
			"orderinfoshare": "Identity and sharing",
			"orderinfotoken": "Session code",
			"orderinfolink": "Session link",
			"orderinfobasic": "Basic information",
			"orderinfoname": "Name",
			"orderinfoclub": "Association",
			"orderinfoplace": "Place",
			"orderinfostart": "Start time",
			"orderinfoend": "End time",
			"orderinfocreate": "Created at",
			"orderinfosystem": "System identifier",
			"orderinfoid": "Session number",
			"orderinfoidnote": "Include this number when reporting an issue so the session can be found faster.",
			"orderinfocopy": "Copy",
			"orderinfocopied": "Copied to clipboard",
			"orderinfocopyfailed": "Copy failed. Please select the text manually",
			"tplplace": "Place",
			"tplbuyin": "Buy-in",
			"tplchip": "Chips",
			"tplante": "Ante",
			"tplbigblindante": "Big Blind Ante",
			"tplshow": "Show",
			"tpledit": "Edit",
			"tpldelete": "Delete",
			"tpladd": "Add",
			...
			"tplsave": "Save",
			"tplclear": "Clear",
			"tplprevpage": "Previous",
			"tplnextpage": "Next",
			"printmeta": "Printed At",
			"printnohand": "No hands to print",
			"handcolposition": "Position",
			"handcolcards": "Hole / Board",
			"handcolaction": "Actions",
			"handcolresult": "Result",
			"handsession": "Session",
			"handtotal": "Total Hands",
			"handsort": "Sort",
			"handsortdesc": "Time: new to old",
			"handsortasc": "Time: old to new",
			"handsectiontitle": "Hand Overview",
			"handempty": "No hands yet",
			"handtitlesuffix": " Hand Overview",
			"handsubtitle": "Hand Record",
			"chipunit": "chips",
			"tablenoheader": "Table No.",
			"statusended": "End",
			"statusrunning": "Running",
			"statuslatereg": "Late Reg.",
			"badgelatereg": "Late Reg.",
			"badgerunning": "Running",
			"badgeended": "Ended",
			"titlemyrecord": "My Record",
			"hintmyrecord": "Quickly edit your rebuy count, place, total buy-in and other personal results.",
			"titlehostaction": "Host Actions",
			"contrastfailprefix": "Contrast too low (",
			"contrastfailsuffix": ":1). This colour is hard to read on a large dark screen; use a brighter one.",
			"contrastwarnprefix": "Contrast is low (",
			"contrastwarnsuffix": ":1). It may be hard to read from a distance; check it on the actual screen.",
			"printnorank": "No ranking data yet",
			"printcolno": "No.",
			"printcolstatus": "Status",
			"printcoltable": "Table",
			"printcolseat": "Seat",
			"printcolprofit": "Profit",
			"printnoregistration": "No registrations yet",
			"printcolstart": "Start",
			"printcollevel": "Level",
			"printcolsb": "SB",
			"printcolbb": "BB",
			"printcolante": "Ante",
			"printcolduration": "Duration (min)",
			"printcolnote": "Note",
			"printchipraise": "Chip race ",
			"printbreak": "Break",
			"printnostructure": "No structure data yet",
			"printnotloaded": "Session data is still loading; please print again in a moment",
			"printsectionsummary": "Session Summary",
			"printsectionregstats": "Registration Stats",
			"printstatregistered": "Registered",
			"printstatconfirmed": "Confirmed",
			"printstatcancelled": "Cancelled",
			"printstatcount": "Rows",
			"printsectionrank": "Final Rankings",
			"printsectionreglist": "Registration List",
			"printsectionstructure": "Structure",
			"printsignstaff": "Staff Signature",
			"printsignmanager": "Manager Signature",
			"printsessionfallback": "Session",
			"printtitlesuffix": " Session Record",
			"printsubtitle": "Session Detail Record",
			"confirmdelete": "Delete this?",
			"deletesuccess": "Deleted",
			"deletefail": "Delete failed",
			"loadslow": "Loading is taking a while; check your connection and retry",
			"rankbusted": "Busted",
			"rankrunning": "Running...",
			"rankadvancedwith": "Advanced (",
			"rankadvanced": "Advanced",
			"cardvenue": "Venue",
			"cardgametypelabel": "Game Type",
			"cardprofit": "Profit",
			"cardplace": "Place",
			"confirmdeleteforever": "Delete this? This cannot be undone!",
			"sessionnotfound": "Session not found",
			"linkopened": "This session is open for linked-user registration",
			"linkclosed": "This session is not open for linked-user registration",
			"titlehired": "Hired",
			"hintstaffnoreg": "Hired staff cannot register for this session.",
			"titleregister": "Register",
			"hintregclosed": "Registration is currently closed.",
			"registersuccess": "Registered; waiting for the host to confirm",
			"erralreadyregistered": "You have already registered",
			"errownsession": "You cannot register for your own session",
			"errstaffnoreg": "Hired staff cannot register for this session",
			"errsessionended": "This session has ended",
			"errregclosed": "This session is not open for registration",
			"confirmcancelreg": "Cancel your registration?",
			"cancelregdone": "Registration cancelled",
			"rebuymax": "Rebuy Limit",
			"rebuycount": "Rebuy Count",
			"reentrymax": "Re-entry Limit",
			"reentrycount": "Re-entry Count",
			"addonmax": "Add-on Limit",
			"addoncount": "Add-on Count",
			"importedprefix": "Imported ",
			"chipsetdefault": "chip set",
			"blockpayout": "Prize column (full row, incl. prize pool and other rewards)",
			"blockstack": "Average stack and entries",
			"blocknextblind": "Next blind level and progress bar",
			"blockmarquee": "Marquee and other rewards",
			"orderdefault": "Default (Prize / Timer / Info)",
			"orderpci": "Prize / Timer / Info",
			"orderpic": "Prize / Info / Timer",
			"ordercpi": "Timer / Prize / Info",
			"ordercip": "Timer / Info / Prize",
			"orderipc": "Info / Prize / Timer",
			"ordericp": "Info / Timer / Prize",
			"hintdefaultcolor": "The built-in green is used when no accent colour is set.",
			"contrastlowsuffix": "Good contrast (",
			"relationoutgoing": "This event leads to other events",
			"relationincoming": "Other events lead to this event",
			"relationsatellite": "Satellite: source can win a target ticket",
			"relationmultiday": "Multi-day: source advances to target",
			"confirmdeleteseries": "Delete this event?",
			"savesuccess": "Saved",
			"actionblind": "Blind",
			"cumulativechip": "Cumulative Chips",
			"sorttime": "Time ",
			"statusregistered": "Registered",
			"statusconfirmed": "Confirmed",
			"statusadvanced": "Advanced",
			...
			"cardeventtype": "Event",
			"cardmaxseat": "Seats per Table",
			"cardantemode": "Ante Mode",
			"cardbuyinfee": "Buy-in (Fee)",
			"cardbuyinchip": "Buy-in Chips",
			"cardticketvalue": "Ticket Value",
			"cardguaranteed": "Guaranteed Prize",
			"sectionbuyinrule": "Buy-in Rules",
			"rulereentry": "Re-entry",
			"rulerebuy": "Rebuy",
			"ruleaddon": "Add-on",
			"sectionsessionsetting": "Session Settings",
			"setticketenabled": "Allow Tickets",
			"setregclosed": "Registration Closed",
			"setlinkuser": "User Link",
			"setopenregistration": "Open Registration",
			"setprivate": "Private Game",
			"setsessionended": "Session Ended",
			"setunifiedhand": "Unified Hand Record",
			"setautostart": "Auto-start by Time",
			"paymentticket": "Ticket",
			"paymentcash": "Cash",
			"cardmyentry": "My Entry",
			"cardmyplace": "My Place",
			"cardmyprize": "My Prize",
			"cardmyprofit": "My Profit",
			"levelbreak": "Break",
			"roleopenstatus": "Registration is open",
			"roleopennext": "Read the rules and time, then register if everything looks right.",
			"roleopencta": "Register Now",
			"roleopenfocus": "The player view makes clear whether you can register and what to do next.",
			"roleopenhelper": "No need to dig into hands, settings or other admin info first.",
			"roleclosedstatus": "Registration is closed or not linked to player registration yet",
			"roleclosednext": "Check the start time, entry conditions and the host's announcement.",
			"infocurrentrole": "Your Role",
			"inforegstatus": "Registration",
			"infonotregistered": "Not registered",
			"infotimer": "Timer",
			"infotimerlinked": "Linked",
			"infotimerunlinked": "Not linked",
			"inforegistration": "Registration",
			"inforegopen": "Open",
			"inforegclosed": "Closed",
			"guidehost1": "Check whether registration is open and whether you need the registration list for the on-site roster.",
			"guidehost2": "If the session is running, check the timer and registration-closed status first.",
			"guidehost3": "Only go into other settings when rules need changing, to avoid on-site distraction.",
			"guidestaff1": "Check the current level, players left and whether registration is closed.",
			"guidestaff2": "Open the console only when the live pace needs handling.",
			"guidestaff3": "If you only need information, the overview is enough; no need for settings.",
			"guidehired1": "Confirm you are assisting as staff; no player registration action is needed.",
			"guidehired2": "Check the current session status, seating and progress.",
			"guidehired3": "Open the matching tool page with the host when needed.",
			"guideplayer1": "Check whether registration is open and your own status.",
			"guideplayer2": "Once confirmed, check your place, seat and timer info.",
			"guideplayer3": "Deeper data such as hands and other settings come later; open them when needed.",
			"quickregisterdesk": "Registration Desk",
			"quicktimerconsole": "Timer Console",
			"quickdisplaypage": "Display",
			"quicksessionsettings": "Session Settings",
			"quickgotoconsole": "Go to Console",
			"quickviewtable": "View Tables",
			"quickoverview": "Overview",
			"quicktableseat": "Tables / Seats",
			"quicktimerdisplay": "Timer Display",
			"roleplayer": "Player",
			"roleplayerstatus": "Can view session information",
			"roleplayernext": "Check the time, venue and whether registration is open.",
			"roleplayercta": "View Overview",
			"roleplayerfocus": "What you need first is the session basics and registration status.",
			"roleplayerhelper": "After the necessary actions, look further at tables, hands and other details.",
			"rolehost": "Host / Admin",
			"rolehoststatus": "Can manage registration, timer, settings and structure",
			"rolehostnext": "Check the registration status and timer first, then decide whether to enter the admin area.",
			"rolehostcta": "Go to Admin Area",
			"rolehostfocus": "The host view puts admin entries and on-site tools first.",
			"rolehosthelper": "The registration list, timer console and session settings are grouped in the quick links.",
			"rolefloor": "Floor",
			"roleassistant": "Assistant",
			"rolestaffstatus": "Can assist the live flow and operate the timer",
			"rolestaffnext": "Check the current registration and timer status, then open the console for on-site actions.",
			"rolestaffcta": "Open Timer Console",
			"rolestafffocus": "What matters most now is the current pace, whether registration is closed, and the next on-site step.",
			"rolestaffhelper": "Deep settings are not on the first screen; focus on what the live flow needs.",
			"rolehired": "Hired Staff",
			"rolehiredstatus": "Can view related sessions and assist, but cannot register as a player",
			"rolehirednext": "Check your scope of assistance and the current session status.",
			"rolehiredcta": "View Session Status",
			"rolehiredfocus": "The staff view shows the essentials first, not the player registration action.",
			"rolehiredhelper": "If you are a floor or assistant, timer entries are shown separately.",
			"roleregisteredstatus": "You have registered; waiting for the host to confirm",
			"roleregisterednext": "Keep this page to track the confirmation; cancel if your plans change.",
			"roleregisteredcta": "View My Status",
			"roleregisteredfocus": "What matters most now is waiting for confirmation; deep admin info is not needed yet.",
			"roleregisteredhelper": "After confirmation, watch the seat, players left and timer display.",
			"roleconfirmedstatus": "You are confirmed",
			"roleconfirmednext": "Check your place and entry data first, then the table or timer as needed.",
			"roleconfirmedcta": "View My Data",
			"roleconfirmedfocus": "Your first screen shows your own result and what to watch next.",
			"roleconfirmedhelper": "If you busted and re-entry is available, the main action becomes re-entry.",
		},
		"sessionresult": {
			"title": "My Result",
		...
		"toolseo": {
			...
			"apidocbody": "Some PokerTrace tools expose a public API you can call from your own site, a Discord bot or a spreadsheet — equity and ICM for example. This page lists each endpoint's URL, parameters and response format.",
			...
			"chipcolorbody": "White 1, red 5, green 25, black 100 for cash games; 25 / 100 / 500 / 1000 / 5000 for tournaments. A quick reference for outfitting a new game. Sign in and set up a chip set in your profile to see your own chips above instead.",
			...
			"chipracebody": "When small denominations are removed, chips that cannot make up a whole larger chip are traditionally decided by dealing for high card (a chip race). This tool works out how many new chips the table needs and how much value is left over across the table.",
			...
			"equitybody": "Enter your hand and your opponents' (Hold'em, Omaha, Omaha Hi-Lo, Big O and Short Deck are all supported) plus the board, and the tool works out each player's equity, tie percentage and remaining outs in real time. For split-pot games the numbers switch to average pot share and scoop rate, and qualifying low hands are highlighted.",
			...
			"handbooktitle": "Poker Handbook",
			"handbookbody": "This handbook summarizes common games and variants, including Hold'em, Omaha, Draw, and Stud families. Each entry lists the hand structure, deal flow, and winner rule in a compact format for hosts, floors, dealers, and players.",
		...
		"errorlist": {
			...
			"ERROR_invalid_gametype_code": "Game type codes can only use uppercase letters and numbers",
			"ERROR_duplicate_gametype_code": "This game type code already exists",
			"ERROR_zz_required": "ZZ is the required Other type and cannot be deleted",
			...
			"ERROR_user_banned": "This account has been blocked or suspended",
			"ERROR_user_not_found": "User not found",
			"ERROR_session_not_found": "Session not found",
			"ERROR_icm_no_player": "No active players are available for ICM allocation",
			"ERROR_icm_player_limit": "ICM allocation supports up to 18 active players",
			"ERROR_icm_chip_missing": "An active player is missing a chip count, so ICM cannot be allocated",
			"ERROR_icm_no_prize": "No prize setup is available for allocation",
			...
			"ERROR_staff_already_clockedin": "Already clocked in",
			"ERROR_staff_not_clockedin": "Not clocked in yet. Please clock in first",
			"ERROR_staff_already_onbreak": "Already on break",
			"ERROR_staff_not_onbreak": "Not on break",
			"ERROR_follow_not_found": "Follow not found",
			"ERROR_follow_target_not_found": "Organizer not found",
			"ERROR_cannot_follow_self": "You cannot follow yourself",
			"ERROR_staff_already_ontable": "This staff member is already assigned to another table",
			"ERROR_staff_not_found": "Staff member not found",
			"ERROR_tablestaff_not_found": "Table assignment not found",
			"ERROR_worklog_not_found": "Work log not found",
			"ERROR_worklog_time_invalid": "Invalid time. The end time must be after the start time and cannot be in the future",
			"ERROR_worklog_time_overlap": "This period overlaps an existing work log",
			"ERROR_staff_already_invited": "This staff member has already been invited",
			"ERROR_staff_self_invite": "You cannot invite yourself",
			"ERROR_staff_role_mismatch": "The account type does not match the role being assigned",
			"ERROR_staff_cannot_register": "Hired staff cannot register for a session they work at",
			"ERROR_seating_not_found": "Seating record not found",
			"ERROR_verifytoken_invalid": "This verification link is no longer valid. Please request a new one",
			"ERROR_confirm_text_error": "The confirmation text does not match",
			"ERROR_datatype_error": "Invalid data type",
			"ERROR_deleteuser_error": "Failed to delete the user. Please try again later",
			"ERROR_deleteuseraccount_error": "Failed to delete the account. Please try again later",
		...
		"profile": {
			"staffidlabel": "User ID",
			"colornotinpalette": " (not in palette)",
			"cardfacecardtitle": "Card Face Colours",
			"cardfacecarddesc": "Applies site-wide, including hand details, session hands and tables.",
			"cardfacetwo": "Two-colour",
			"cardfacefour": "Four-colour",
			"displaydefaultcardtitle": "Display Brand Defaults",
			"displaydefaultcarddesc": "Set once and every new session inherits it. Editing a single session never changes this.",
			"displaydefaultmodaldesc": "These are the initial values for new sessions. Existing sessions are unaffected; edit them from their own settings page.",
			"emptydisplaydefault": "No display brand defaults set",
			"displaydefaultname": "Brand / club name",
			"displaydefaultlogo": "Logo image URL",
			"displaydefaultlogohint": "Only http/https URLs are accepted. The display caps the height at 34px, so a wide transparent image works best.",
			"displaydefaultcolor": "Accent color",
			"displaydefaultclear": "Clear",
			"displaydefaultblocks": "Blocks to show",
			"displaydefaultorder": "Column order",
			"displaydefaultorderhint": "Column order only applies above 900px width. Phones and tablets use a stacked layout with no three columns to reorder.",
			"displaydefaultcolorunset": "Using the built-in green when no accent is set.",
			"displaydefaultcolorlow": "Contrast too low; this color will be hard to read on the dark display",
			"displaydefaultcolormid": "Contrast is low; may be hard to read from a distance",
			"displaydefaultcolorok": "Contrast is good",
			"displaydefaulthaslogo": "logo set",
			"displaydefaulthasorder": "column order set",
			"displaydefaulthidden": "hidden blocks: ",
			"displayblockpayout": "Payout column (incl. prize pool and other rewards)",
			"displayblockstack": "Average stack and entries",
			"displayblocknextblind": "Next level blinds and progress bar",
			"displayblockmarquee": "Marquee and other rewards",
			"displayorderdefault": "Default (Payout / Clock / Info)",
			"displayorderpci": "Payout / Clock / Info",
			"displayorderpic": "Payout / Info / Clock",
			"displayordercpi": "Clock / Payout / Info",
			"displayordercip": "Clock / Info / Payout",
			"displayorderipc": "Info / Payout / Clock",
			"displayordericp": "Info / Clock / Payout",
			"title": "Profile",
			"playerid": "Player ID",
			"monthreport": "Monthly",
			"yearreport": "Yearly",
			...
			"staffinputplaceholder": "Enter user ID (e.g. 00000099)",
			"empty": "No members",
			"unemployed": "This user is not employed by any player yet.",
			"unnamed": "Unnamed player",
			"pending": "Pending",
			"filterall": "All",
			"filterempty": "No one matches this filter",
			"filtersearch": "Search name or ID",
			...
			"toolequitydesc": "Hold'em / Omaha / Omaha Hi-Lo / Big O / Short Deck equity and outs",
			...
			"cardfaceskincardtitle": "Card Face",
			"cardfaceskincarddesc": "The card face can use a different style from the card back.",
			"carddeckcardtitle": "Card Back",
			"carddeckcarddesc": "Choose the card back style for hand replay.",
			"decknotlisted": " (not in the list)",
			"deckclassic": "Classic",
			"deckcrimson": "Crimson",
			...
			"gametypeadmincardtitle": "Game Type Settings",
			"gametypeadmincarddesc": "Add and manage available games, including each game's deal, betting, and winner flow.",
			"gametypeadminopen": "Open Settings",
		...
		"handdetailpage": {
			...
			"lowhand": "Low",
			"boardrun": "Run {n}",
			"boardrunpot": "Pot {amount}",
			"boardrunwinner": "Seat {seat} wins {amount}",
			"multiboard": "Ran {n} times",
			"burn": "Burn",
			"unknown": "Unknown",
			"start": "Start",
			"end": "End",
			...
			"streetriver": "River",
			"actionblind": "Blind",
			"printnotloaded": "Hand data not loaded yet",
			"printhand": "Hand",
			"printdate": "Date",
			"printdealerseat": "Dealer Seat",
			"printrecord": "Record",
			"printpublicrecord": "Public Record",
			"printblind": "Blinds",
			"printtotalpot": "Total Pot",
			"printherohand": "Hero Cards",
			"printboard": "Board",
			"printcolseat": "Seat",
			"printcolplayer": "Player",
			"printcolhand": "Cards",
			"printcolstart": "Start",
			"printcolend": "End",
			"printcolnet": "Net",
			"printcolwon": "Won",
			"printwonyes": "Yes",
			"printnoseating": "No seating data",
			"printcolstreet": "Street",
			"printcolaction": "Action",
			"printcolamount": "Amount",
			"printnoaction": "No action data",
			"printsectionnote": "Note",
			"printsectionboard": "Board",
			"printsectionseating": "Seat Results",
			"printsectionaction": "Actions",
			"printtitleprefix": "Hand",
			"printtitlesuffix": "Detail",
			"printsubtitle": "Single Hand Record",
			"printmeta": "Printed At"
		},
		"follow": {
			"title": "Following Organizers",
			"desc": "Follow an organizer to get notified when they open a new session. You can also use the Following quick filter on the session list.",
			"privacynote": "Only you can see this list. Organizers are never told who follows them.",
			"add": "Add",
			"follow": "Follow",
			"following": "Following",
			"unfollow": "Unfollow",
			"unfollowconfirm": "Unfollow this organizer? You will stop receiving notifications about their new sessions.",
			"unfollowed": "Unfollowed",
			"scope": "Venue scope",
			"scopeall": "All venues",
			"scopeallhint": "Venues added later are included automatically",
			"scopeselected": "Selected venues only",
			"scopecount": "{selected} of {total} selected",
			"scopeempty": "No venues available",
			"scoperequired": "Select at least one venue",
			"venuecount": "{selected} of {total} venues",
			"notifyon": "Notifications on (tap to turn off)",
			"notifyoff": "Notifications off (tap to turn on)",
			"notifylabel": "Notify me about new sessions",
			"modaltitleadd": "Add an organizer to follow",
			"modaltitleedit": "Following settings",
			"hostlabel": "Organizer",
			"targetlabel": "Choose an organizer",
			"targetempty": "No organizers available to follow",
			"targetemptynext": "Once public sessions from other organizers show up in your session list, they will appear here.",
			"targetfollowed": "Following",
			"save": "Save",
			"saved": "Following settings saved",
			"saving": "Saving…",
			"removing": "Working…",
			"cancel": "Cancel",
			"close": "Close",
			"emptylist": "You are not following any organizer yet",
			"emptylistnext": "Open a session and tap Follow next to the organizer, or use Add above.",
			"loadfail": "Could not load your following list",
			"retry": "Reload"
		},
		"sessionlist": {
			"title": "Session List",
			...
			"printcolname": "Name",
			"printcolcode": "Code",
			"printcolbuyin": "Buy-in",
			"printcolrank": "Rank",
			"printcolprofit": "Profit",
			"printtotalsession": "Total Sessions",
			"printtotalprofit": "Total Profit",
			"printavglength": "Avg Duration",
			"printcount": "Rows Printed",
			"printsectiontitle": "Session List",
			"printempty": "No sessions found",
			"printsignstaff": "Staff Signature",
			"printsignmanager": "Manager Signature",
			"printtitle": "Session List",
			"printsubtitle": "Session List Record",
			"printmeta": "Printed At",
			...
			"emptyfollowed": "No sessions from the organizers you follow",
			"emptyfollowednext": "Either you are not following anyone yet, or they have no sessions right now.",
			"followmanage": "Manage following",
			"followedmarktitle": "You follow this session's organizer",
			...
			"sessionnamefilter": "Session Name",
		...
		"benefit": {
			"incompletedata": "Large data set: only the most recent {loaded} of {total} sessions are included. Every number above excludes the older records.",
			"title": "Advanced Report",
			"clubsectiontitle": "By Club",
			"clubsectiondesc": "Net profit per club over the same date range. Uses the same exclusions as the trend chart above: sessions you host and sessions you worked as staff are both left out.",
			"clubheadname": "Club",
			"clubheadcount": "Sessions",
			"clubheadprofit": "Net Profit",
			"clubuncategorized": "No club set",
			"clubempty": "No groupable data in this range",
			"clubemptydesc": "Adjust the date range, or check that your sessions have a club set.",
			"startdate": "Start Date",
			"enddate": "End Date",
			"search": "Search",
			"reset": "Reset",
		...
		"auth": {
			...
			"ERROR_user_banned": "This account has been blocked or suspended and cannot continue using account-only features.",
			"ERROR_invalid_gametype_code": "Game type codes can only use uppercase letters and numbers.",
			"ERROR_duplicate_gametype_code": "This game type code already exists.",
			"ERROR_zz_required": "ZZ is the required Other type and cannot be deleted.",
			"NETWORK_ERROR": "The network connection is unstable. Please try again.",
		...
		"blockedpage": {
			"pagetitle": "Account Unavailable - PokerTrace",
			"eyebrow": "Account notice",
			"title": "Your account is currently unavailable",
			"message": "This account has been blocked or suspended, so you cannot sign in or use features that require account access.",
			"reviewtitle": "Need a review?",
			"reviewbody": "If you believe this action is in dispute, please contact us by email or through the contact page.",
			"contact": "Go to Contact Us",
		...
		"indexpage": {
			...
			"feat9title": "Animated Hand Replay",
			"feat9desc": "Replay any hand as an animation with dealing, betting, showdown, payout, and all-in equity.",
			...
			"indextoollistlink": "See all free tools →",
			"toolequitytitle": "Equity Solver",
			"toolequitydesc": "Hold'em / Omaha / Omaha Hi-Lo / Big O / Short Deck equity and outs",
			"tooltbtitle": "Timebank Timer",
			...
			"toolstructuregentitle": "Structure Generator",
			"toolstructuregendesc": "Live blind structure, auto chip race, export JSON",
			"toolhandbooktitle": "Poker Handbook",
			"toolhandbookdesc": "Hold'em, Omaha, Draw, and Stud game guide",
			"toolfstitle": "Postflop GTO Solver",
			"toolfsdesc": "In-house CFR, solves flop spots in real time",
			"toolcstitle": "Starting Chip Setup",
			"toolcsdesc": "Auto-suggest chip counts per player",
		...
		"rangepickerpage": {
			...
			"placeholder": "For example: UTG vs BTN",
			"color": "Marking color",
		...
		"equitypage": {
			...
			"superholdem": "Super Hold'em",
			"deuceswild": "Deuces Wild",
			"boardmode": "Board Count",
			...
			"selectedrange": "Selected hands",
			"norangeset": "No range selected",
			"rangeplaceholder": "For example AKs,AQo+,TT+,22-99,random",
			"rangehint": "Leave blank to use the picked cards above; enter a range to solve by range.",
			"rangecount": "Combos",
			"rangesample": "Samples",
			"rangeerror": "Range format is invalid, or conflicts with board / dead cards",
			"rangeonlyholdem": "Range solving currently supports 2-card hole games only",
			"solvefail": "Solve failed, please try again"
		},
		"timebankdrillpage": {
			"labelplaceholder": "For example: Final table",
		...
		"potoddspage": {
			"outsnote": "Outs are the cards left that complete your hand. Rule of 4 and 2: with two cards to come multiply outs by 4, with one card to come multiply by 2, for a quick estimate of your chance to hit.",
			"title": "Pot Odds",
			"back": "Back",
			"pot": "Current Pot",
			"call": "Amount to Call",
		...
		"registerpage": {
			"seatoutofrange": " (out of range)",
			"tablenotfound": " (table removed)",
			"batchtitle": "Batch Confirm & Seating",
			"batchhint": "Check the players to process first, then batch confirm or seat them. Seating applies only to confirmed players.",
			"selectall": "Select All",
			"batchconfirmbtn": "Batch Confirm",
			"startchipplaceholder": "Starting chips",
			"fillunseatedbtn": "Fill Unseated",
			"reseatselectedbtn": "Reseat Selected",
			"balanceallbtn": "Balance All Tables",
			"applybestchipbtn": "Apply Highest Advance Chips",
			"filterplaceholder": "Search name / ID / place",
			"filterall": "All",
			...
			"prevpage": "Previous",
			"nextpage": "Next",
			"searchplayerbtn": "Search Player",
			"sessionmax": "Event limit ",
			"financefix": "Adjust",
			"autoprizehint": "Blank means auto prize",
			"applyicm": "ICM Allocate",
			"applyicmconfirm": "ICM allocation will use current active-player chips and the prize table, then overwrite those players' prize fixes. Continue?",
			"applyicmdone": "ICM allocation completed for {n} players",
			"helpconfirmlabel": "Confirm registration: ",
			"helpconfirmtext": "Moves a player from Registered to a state that can be seated and counted in the live flow.",
			"helpseatlabel": "Seating: ",
			"helpseattext": "Applies only to confirmed players. You can fill unseated players, reseat selected players, or balance all tables.",
			"helpadvancelabel": "Advance: ",
			"helpadvancetext": "Moves a player to the next target event and keeps that player's advance chip count.",
			"helpfinancelabel": "Finance fix: ",
			"helpfinancetext": "Only edits this registration's financial data; it never writes back to the session settings.",
			"helpregisteredtext": "The player submitted a registration but the host has not confirmed it yet.",
			"helpconfirmedtext": "Can be seated and counted in the live headcount and later operations.",
			"helpadvancedtext": "Moved to the next target event; on repeat advances the higher chip count is kept.",
			"helpcancelledtext": "This registration is void. If the player busted, check whether re-entry is still available.",
			"helpflow1": "Search for or add a player, and decide whether to register with cash or a ticket.",
			"helpflow2": "Batch confirm first, then fill unseated players or balance seats, to avoid seating chaos.",
			"helpflow3": "Handle re-entry, advancing and finance fixes when players bust or on multi-day events.",
			"helpflow4": "After each batch action, read the summary on this page before deciding the next step.",
			"advancechiptitle": "Set Advance Chip Count",
			"advancechipdesc": "The player will be moved to the next day of the event. On repeat advances, the highest chip count is kept.",
			"scanlink": "Scan QR",
			"backtosession": "Back to session",
			"helpsummary": "Instructions / Status guide / Getting started",
			"helpoperationtitle": "Instructions",
			"helpstatustitle": "Status guide",
			"helpguidetitle": "Getting started",
			"helptoggle": "Expand / Collapse",
			"heading": "Registration List",
			"listheading": "Registration Roster",
			"listnote": "Click a column to sort. Tick rows for batch actions. Export the current filter from the right.",
			"printlist": "Print roster",
			"colselect": "Select",
			"colfix": "Adjust",
			"colprofit": "Profit",
			"colaction": "Actions",
			...
			"reentryunit": " times",
			"addonlabel": "Add-on ",
			"prizefixlabel": "Prize fix ",
			"ticketvaluelabel": " / Ticket value ",
			"financetitle": "Edit Registration Data",
			"financedesc": "This only edits this player's registration finance data; the event settings are unchanged.",
			"financereentry": "Re-entry Count",
			"financerebuy": "Rebuy Count",
			"financeaddon": "Add-on Count",
			"financeprize": "Prize Fix",
			"financeticket": "Ticket Value",
			"financepayment": "Payment Method",
			"paymentcashbuy": "Cash",
			"paymentticketbuy": "Ticket",
			"save": "Save",
			"register": "Register",
			"searchdesc": "Search by player ID, name or email. For a new walk-in player, check whether they already have an account.",
			"staffcannotregister": "Staff cannot register",
			"nomatchplayer": "No matching player",
			"nomatchuser": "No matching user",
			"addplayer": "Add Player",
			"searchplaceholder": "Player ID / Name / Email",
			"searchhint": "Search by player ID, name or email to add, or register a walk-in player directly.",
			"testuser": "Test Users",
			"confirm": "Confirm",
			"advance": "Advance",
			"eliminate": "Eliminate",
			"updatechip": "Update Chips",
			"printreceipt": "Print Receipt",
			"printprizereceipt": "Print Prize Receipt",
			"reentrymaxed": "Re-entry limit reached",
			"reentryfail": "Re-entry failed",
			"seatafterconfirm": "Seatable after confirming",
			"bustedneedreentry": "Busted, re-entry required",
			"tableseatchip": "Table / Seat / Chips",
			"advancedprefix": "Advanced ",
			"chipmid": " / Chips ",
			"repeatadvanceprefix": "Repeat advances ",
			"repeatadvancemid": " / highest ",
			"costlabel": "Cost ",
			"placelabel": "Place ",
			"autoprizelabel": "Auto prize ",
			"updatecurrentplaces": "Update Current Places",
			"saveplace": "Save Place",
			"placeupdated": "Current places updated",
			"placesaved": "Place saved",
			"invalidplace": "Enter a positive place, or leave it blank to clear",
			"advancenoplace": "Advanced, no place needed",
			"printcolno": "No.",
			"printcolplayer": "Player",
			"printcolregtime": "Registered At",
			"printcolstatus": "Status",
			"printcoltable": "Table",
			"printcolseat": "Seat",
			"printcolbuyin": "Buy-in",
			...
			"printtotalcount": "Total Rows",
			"printtotalchip": "Total Chips",
			"totalchipdifftitle": "Difference from the expected total. Expected:",
			"printsectiontitle": "Registration List",
			"printsignstaff": "Staff Signature",
			"printsignmanager": "Manager Signature",
			"printtitlesuffix": " Registration List",
			"printsubtitle": "Registration List Record",
			"printmeta": "Printed At",
			"panelregisterresult": "Registration Result",
			"paneladded1": "1 player added",
			"paneladdedmsg": "The player found in the search has been added to this event. You can confirm or assign a seat next.",
			"labelsuccess": "Success",
			"labelfail": "Failed",
			"labelnext": "Next",
			"valueconfirmseat": "Confirm / Seat",
			"panelseatresult": "Seating Result",
			"panelfilledtitle": "Unseated players filled in",
			"panelfilledmsg": "Unseated players were processed with the chosen table and starting stack. Please check whether any manual adjustment is still needed.",
			"labelmode": "Mode",
			"valuefillunseated": "Fill unseated",
			"labeltable": "Table",
			"labelchip": "Chips",
			"panelreseattitle": "Selected players reseated",
			"panelreseatmsg": "Only the checked confirmed players were reassigned; other players are unaffected.",
			"valuereseatselected": "Reseat selected",
			"panelbalancetitle": "Seats balanced",
			"panelbalancemsg": "All tables were balanced. Please check individual tables for any fine-tuning.",
			"valuebalanceall": "Balance all",
			"labelstartchip": "Starting Chips",
			"valuechecktable": "Check tables",
			"panelbatchconfirm": "Batch Confirm Summary",
			"panelbatchtitle": "Batch confirm completed",
			"panelbatchmsg": "The batch confirm is done. Next, check the unseated players and decide whether to fill in or balance the seats.",
			"valuefillseat": "Fill / Seat",
			"panelapplymax": "Apply Highest Chips",
			"panelapplyoktitle": "Highest advance chips applied",
			"panelapplyfailtitle": "Some players failed",
			"panelapplymsg": "Repeat-advance players' starting stacks were updated to their own highest advance chip count.",
			"panelseatsaved": "Seat Result",
			"panelseatsavedtitle": "Seat adjustment saved",
			"panelseatsavedmsg": "This player's table, seat and starting stack have been updated.",
			"labelplayer": "Player",
			"valuesingleseat": "Single seat adjustment",
			"missingsessionid": "Missing sessionid",
			"noseat": "Unseated",
			"needadvancechip": "Please enter the advance chip count",
			"multiadvancetarget": "This event has multiple advance targets; please tidy up the relation settings first",
			"paymentticket": "Ticket",
			"paymentcash": "Cash",
			"prizeauto": "Auto",
			"pageinfoprefix": "Showing ",
			"pageinfomid": " · page ",
			"pageinfosuffix": "",
			"noregistration": "No registrations yet",
			"nomatchregistration": "No registrations match the filter",
			"confirmcancel": "Cancel this player's registration?",
			"eliminateconfirm": "Eliminate this player?",
			"eliminatedone": "Player marked eliminated",
			"advancedtoprefix": "Advanced to ",
			"advancedcountmid": ", total advances: ",
			"advancedcountsuffix": "",
			"registrationnotfound": "Registration not found",
			"entrypending": "Pending",
			"needselectconfirm": "Please select the players to confirm first",
			"noduplicateadvance": "No repeat-advance players to apply the highest chip count to",
			"confirmapplyprefix": "Apply the highest advance chip count to ",
			"confirmapplysuffix": " repeat-advance players' starting stacks?",
			"edited": "Updated",
			"statusregistered": "Registered",
			"statusconfirmed": "Confirmed",
			"statusadvanced": "Advanced",
			"statuscancelled": "Cancelled",
			"noprintdata": "No registration data to print",
			"needselecttable": "Please choose a table first",
			"needselectreseat": "Please select the players to reseat first",
		...
		"gtopage": {
			...
			"dataloadfail": "Failed to load strategy data. Please refresh.",
			"chip_tabletype": "Players",
			"chip_stack": "Stack",
			"chip_spot": "Spot",
			"chip_gametype": "Game",
			"chipmore": "More +",
			"grade_solved": "Solved",
			"grade_ref": "Reference",
			"emptynodetitle": "No dedicated range for this branch yet",
			"emptynodedesc": "You did not make a wrong selection. This is usually a cold-call, squeeze, cold 4-bet, or big-blind-vs-limp branch; the range library does not fully cover those lower-frequency lines yet.",
			"emptynodehinttitle": "Useful nearby references:",
			"emptynodehint1": "Step back and inspect the opener, 3-bettor, or all-in player's main range.",
			"emptynodehint2": "For shorter stacks, switch to the short-stack all-in tree and check this position's push/fold reference.",
			"emptynodehint3": "For deep multiway pots, use the RFI / 3-bet heads-up range as a conservative baseline and discount marginal hands.",
			...
			"fs_fslibtitle": "Prebuilt strategy library",
			...
			"fs_fslibempty": "This environment does not provide a prebuilt strategy library. You can use the range solver below instead.",
			"fs_fslibfail": "Failed to load",
			"fs_fslibnotready": "The library does not have this matchup on this flop yet. You can use the range solver below instead.",
...
"handrankingpage": {
		...
		"chipcolorpage": {
			...
			"back": "Back",
			"note": "These are common industry cash-game color conventions, not your own settings; venues and tournaments vary, follow the on-site posting. Sign in and set up a chip set in your profile to see your own chips here.",
			"profilenote": "These are the chips from your profile chip set. Color names come from your palette; a color that is not in your palette shows its hex code instead."
		},
		"handsestpage": {
		...
		"adminuserpage": {
			...
			"permissionoutofrange": " (outside Lv1-Lv5)",
			"tablog": "Records",
			"tabuser": "Users",
			"eyebrow": "User Management",
		...
		"guidepage": {
			"title": "Guide",
			"description": "PokerTrace guide covering sessions, registration and seating, the timer, hand logging, stats and payouts, series, hand replay, following organizers, staff hiring, on-site check-in, and the tool center.",
			"heading": "Guide",
			"lead": "This page organizes the complete PokerTrace workflows. Jump straight to the section that matches your role and what you need right now — from session setup, registration and seating, the timer, hand logging, and stats and payouts, to series, hand replay, following organizers, staff hiring, on-site check-in and receipts, and the tool center.",
			...
			"chapters": [
				...
				},
				{
					...
					"items": [
						...
						{
							"id": "player-follow-host",
							"title": "4. Follow the organizers you play with",
							"desc": "There are many organizers on the site, but you probably only play a few of them regularly. Follow them and the session list can show only their events via the Following quick filter; you also get notified when they publish something new, so you do not have to keep checking back. If an organizer runs several venues, you can narrow the follow to just the ones you go to.",
							"steps": [
								"Open any session hosted by someone else — the Follow button sits on the organizer row.",
								"Choose all venues or tick only the ones you attend, decide whether to receive new-session notifications, and save.",
								"Back on the session list, the Following quick filter now shows only those organizers' events.",
								"To change the scope, mute notifications, or unfollow, use the Following Organizers section of your profile."
							],
							"tip": "Your following list is private — organizers are never told who follows them or how many. Muting notifications does not affect the Following filter; the two are independent.",
							"pageurl": "profile.html",
							"pagelabel": "Open Following List"
						}
					]
				},
				{
				...
				},
				{
					...
					"lead": "The hand detail page can replay a full hand as an animation from deal to payout, useful for review and sharing.",
					"items": [
						{
							"id": "hand-replay-playback",
							"title": "Animated hand replay",
							...
							"tip": "Replay deck skin can be set in personal preferences; all-in equity is computed on the backend.",
							"tools": [
								{
									"name": "Timeline",
					...
					"items": [
						...
						},
						{
							...
							"steps": [
								...
								"Enter the person's user ID (e.g. 00000099) and click \"Add\" to send the invite.",
		...
		"tablepage": {
			"playernotinlist": " (not in the selectable list)",
			"boardrun": "Run {n}",
			"title": "Table Detail",
			...
			"player": "Player",
			"blind": "Blinds",
			"handrecordnote": "Filter records with the controls below. A new hand carries over the current stacks; chip correction is for adjusting counts on site.",
			"statsnote": "Wins, buy-ins and net totals for this table, updated as hands are recorded.",
			"hand": "Hand",
			"result": "Result",
			"createinfo": "Created",
			"action": "Action",
		...
		"newtablepage": {
			"heading": "New table",
			"labelno": "Table number",
			"submit": "Submit",
			"note": "Enter a single number, or a start and end number to create several tables at once.",
			"labelstartno": "First table number",
			"labelendno": "Last table number",
			"rangenote": "A start and end number creates several tables at once — 1 to 9 creates nine tables. Filling in only one of the range fields creates just that number.",
		...
		"tableboardpage": {
			...
			"movebutton": "Move",
			"eliminatebutton": "Eliminate",
			"movetitle": "Move Player",
			"movedesc": "Choose the table and seat for \"{player}\", or let the system assign one at random.",
			"moverandom": "Random Seat",
			"moveempty": "No table has an open seat",
			"movesuccess": "Player moved",
			"movefail": "Move failed",
			"eliminateconfirm": "Eliminate \"{player}\"?",
			"eliminatesuccess": "Player eliminated",
			"eliminatefail": "Eliminate failed"
		},
		"tablemanage": {
		...
		"newedithandpage": {
			"boardrun": "Run {n}",
			"runboardpot": "Pot {amount}",
			"runboardadd": "+ Run it again",
			"runboardremove": "Remove",
			"chipunit": "Chips",
			"feltsitin": "Sit In",
			"felthint": "Tap an empty seat to add a player ・ Tap a player to edit stack and settings ・ Use the keys below to record actions (removable / undoable)",
			"allocation": "Allocation",
			"navindex": "Home",
			"navprofile": "Profile",
			"navclub": "Clubs",
			"navsession": "Sessions",
			"navbenefit": "Profit Chart",
			"navcontact": "Contact",
			"navclubshort": "Clubs",
			"navsessionshort": "Sessions",
			"navbenefitshort": "Profit",
			"navprofileshort": "Profile",
			"tapcard": "Tap a card",
			"close": "Close",
			"cleartemp": "Clear draft",
			"flowlabel": "Hand steps",
			"step1": "1 Seats",
			"step2": "2 Record",
			"step3": "3 Review",
			"step1title": "Seats & blinds",
			"step1descedit": "Confirm the game type, blinds and dealer before moving on.",
			"step1descquick": "A quick record is a standalone hand: set the game type, blinds and seats however you like.",
			"editlocktitle": "Older hand partially locked",
			"editlockdesc": "This is not the latest hand at this table. To avoid changing later starting stacks, seats, blinds, betting and results are locked. Cards, board cards and notes can still be edited.",
			"editlocktoast": "Older hands can only edit cards, board cards and notes. Seats, blinds, betting and results are locked.",
			"blindlevellabel": "Blind level",
			"emptybutton": "Empty button",
			"deadsmallblind": "Dead small blind",
			"rebuildblinds": "Rebuild default bets",
			"seathintedit": "Tap a seat to set the player and starting stack.",
			"seathintquick": "Pick the occupied seats and enter starting stacks (in big blinds or chips).",
			"step2title": "Record the hand",
			"step2desc": "Pick what to do next; work through it step by step at the table.",
			"hubherocards": "Add my cards",
			"hubbetting": "Betting",
			"hubshowdown": "Showdown / result",
			"hubresultinfo": "Pick cards, pick winners",
			"bettingtitle": "Betting",
			"backtohub": "Back",
			"timebankstart": "Start",
			"timebankpause": "Pause",
			"timebankreset": "Reset",
			"waitingnext": "Working out who acts next…",
			"showdowntitle": "Showdown / result",
			"solvewinner": "Solve",
			"step3title": "Review before saving",
			"step3desc": "Check the warnings first: amber is a heads-up, red must be fixed.",
			"step3noteedit": "The next hand carries over the ending stacks.",
			"step3notequick": "A quick hand is standalone: it is not linked to other hands and can be edited later.",
			"psplaceholderedit": "Notes from the table: rulings, or why something does not line up",
			"psplaceholderquick": "Notes from the table: rulings or anything else worth recording",
			"saveandnext": "Save and start the next hand",
			...
			"tapeditcard": "Tap the card to edit",
			"raiseinvested": "Invested ",
			"raisecalltarget": ", call to ",
			"raiseremain": ", remaining ",
			"raiseminchip": ", minimum chip ",
			"betraiseto": "Bet / raise to",
			"keyclear": "Clear",
			"keyback": "Back",
			"seatprefix": "Seat ",
			"editplayer": "Edit Player",
			"sitin": "Sit In",
			"feltdesc": "Set it up as you record; no need to go back to the table page.",
			"tabname": "Enter Name",
			"tabaccount": "Search Account",
			"nameplaceholder": "e.g. Black Shirt, Baldy",
			"acctplaceholder": "Enter name or player ID...",
			"startstack": "Starting Stack",
			"update": "Update",
			"addseat": "Add Seat",
			"searchnotfound": "Not found; use 「Enter Name」 instead.",
			"boundaccount": " · linked account",
			"tempname": " · temporary name",
			"menurename": "✎ Rename / Link Account",
			"menuhero": "⭐ Set as Hero",
			"menudealer": "🔘 Set as Dealer",
			"menuunknown": "❓ Mark Unknown Stack",
			"menuvacate": "✕ Leave Seat",
			"customlevel": "Custom",
			"removeaction": "Remove",
			"noaction": "No betting action yet",
			"selectcards": "Select",
			"winner": "Winner",
			"invested": "In ",
			"ended": " / End ",
			...
			"hubstreet": "Street",
			"hubpot": "Pot",
			"hubremain": "Players Left",
			"hubnext": "Next",
			"msgfoldedprefix": "All other players folded, only ",
			"msgfoldedsuffix": " remains; the hand is over.",
			"msgallfolded": "All players folded; please check the hand result.",
			"msgstreetdoneprefix": "Everyone has called / checked this round; switch to ",
			"msgstreetdonesuffix": ".",
			"unsupported": " (unsupported)",
			"blindlabel": "Blind",
			"bringinlabel": "Bring-in",
			"deadmoney": " · dead money ",
			"defaultaction": " · default",
			"herosync": " · Hero synced",
			"summaryseat": "Active players: ",
			"summarypot": "<br>Total pot: ",
			"summaryreward": "<br>Reward pot: ",
			"summarywinner": "<br>Winners: ",
			"summaryalloc": "<br>Allocated: ",
			"summaryhint": "<br>The first submit stops on warnings; tap again to force submit.",
			"statusupdating": "Updating...",
			"statussaving": "Saving...",
			"myhand": "My Cards",
			"publicrecord": "Public Record",
			"selecthand": "Select Cards",
			"showdownsubmit": "Showdown / Submit",
			"showcards": " Reveal",
			"exposedup": "Up",
			"exposeddown": "Down",
			"drawnhand": "Cards After Draw",
			"starthand": "Starting Cards",
			"heroprefix": "Me: ",
			"tapdeal": "Tap to deal",
			"drawnprefix": "Drawn ",
			"drawnsuffix": " streets",
			...
			"unknown": "Unknown",
			"quicklowest": "Min",
			"pagetitlequick": "Quick Hand Record",
			"pagetitleedit": "Edit Hand",
			"pagetitlenew": "New Hand",
			"playercountunit": " players",
			"recordtype": "Record Type",
			"heroseat": "Hero Seat",
			"herocards": "Hero Cards",
			"showcardmodal": " show cards",
			"statusloading": "Loading...",
			"statusnotupdated": "Not updated yet",
			"statusnotsaved": "Not saved yet",
			"bringin": "Bring-in",
			"smallblind": "Small Blind",
			"noselect": "None",
			"streetfinished": "Street finished",
			"acting": " to act",
			"boardtitle": "Board",
			"dealtitle": "Deal",
			"drawtitle": "Draw",
			"toastpublicnohero": "Public records have no Hero; fill in each player's cards at showdown",
			"toastnoseat": "No operable seat found",
			"raiserestricted": "The wager is not a full raise, so this player may only call or fold",
			"toastminchipadjust": "Adjusted to the minimum chip: ",
			"toastnoseatnow": "No operable seat right now",
			"toastloading": "Loading data",
			"toastforcesubmit": "There are warnings; tap submit again to force save",
			"toastupdated": "Updated",
			"toastsaved": "Saved",
			"toastwinnerapplied": "Suggested winner applied",
			"toastwinnerappliedsplit": "Suggested winner applied (split pot: the low half went to the qualifying low)",
			"toastnotenoughshow": "Not enough shown cards to solve",
			"confirmquicksolve": "Quick solve will overwrite the winner and allocation you set manually. Continue?",
			"toastneedboard": "Please complete the board (flop, turn, river) before solving",
			"confirmcleartemp": "Clear the draft?",
			"confirmswitchfamily": "Switching the game family clears the betting actions and draw/deal records you entered. Switch anyway?",
			"confirmcleartable": "Clear this table's unsubmitted draft hand data? This cannot be undone.",
			"toasttempcleared": "Draft cleared",
			"streetflop": "Flop",
			"streetturn": "Turn",
			"streetriver": "River",
			"burnflop": "Burn (Flop)",
			"burnturn": "Burn (Turn)",
			"burnriver": "Burn (River)",
			"warnfewseat": "Fewer than 2 active players.",
			"warnbusted": " has 0 chips; submitting will bust this player automatically, no floor action needed.",
			"warnheroincomplete": "Hero cards are not fully selected.",
			"warnnowinner": "No winner selected yet.",
			"warnnopot": "The betting record has no pot at all.",
			"warnpotprefix": "The total pot is not a multiple of the minimum chip ",
			"warnmultiplesuffix": ".",
			"warnnegativestack": " ends with a negative stack.",
			"warnallocprefix": " allocation is not a multiple of the minimum chip ",
			"warnallinprefix": "A player is all-in at showdown, but 「",
			"warnallinburnmid": "」 is empty while 「",
			"warnallinburnsuffix": ") is filled. Did you tap a community card as a burn card?",
			"warnallinmissingsuffix": "」 is not filled yet; please check the board is complete.",
			"checkpass": "Check passed, ready to submit.",
			"selectedcard1": "Board",
			"selectedcard2": "Record",
			"burn": "Burn ",
			"noactionseat": "No seat can act right now",
			"actionmeta": "Put in {put}, need to call {call}",
			"showorderhint": "{seat} should show first; other players may show or muck as the floor decides.",
			"updatefailed": "Update failed",
			"savefailed": "Save failed",
		},
		"stackadjustpage": {
			"pagetitle": "Edit Stack Adjustment",
			"lockednote": "This is not the latest record. Stacks are locked; only the note can be edited.",
			"playercount": "{n} players",
			"nowlabel": "Now",
			"afterlabel": "After",
			"warnnoadjust": "No stack adjustment entered yet.",
			"warnnonote": "Please fill in the note.",
			"heading": "Stack adjust",
			"back": "Back",
			"labeltable": "Table",
			"labelplayer": "Player",
			"labelstatus": "Status",
			...
			"labelnote": "Note",
			"reasonother": "Other",
			"totaldelta": "Net change",
			"totalstack": "Chips in play",
			"reasontitle": "Reason for the adjustment",
			"reasonnote": "This creates a record; the next hand starts from the corrected stacks.",
			"reasoncount": "Recount at the table",
			"reasonrace": "Colour up / race off",
			"reasonpenalty": "Penalty / chip correction",
			"reasonseat": "Seat data correction",
			"psplaceholder": "Record why the stacks were adjusted",
			"adjusttitle": "Stack changes",
			"adjustnote": "Enter how much each player gained or lost.",
			...
			"notadjustrecord": "This is not a stack adjustment record",
			"noteonlystatus": "Not the latest record; note only",
			"notupdated": "Not updated yet",
		},
		"newsessionpage": {
			"modehosted": "Host a Game",
			"modepersonal": "Log Personal Result",
			"modenone": "Not selected",
			"hintstart": "Pick a mode, then fill in from the basics downward.",
			"hintstep1": "Confirm this session's basic details and schedule first.",
			"hintstep2hosted": "Decide the rebuy, re-entry and registration rules.",
			"hintstep2personal": "Mark whether you re-entered, and whether you reached ITM / Final Table.",
			"hintstep3hosted": "Fill in fees and chips, confirm the advanced settings and notes below, then create the session.",
			"hintstep3personal": "Fill in your actual spending and result, confirm the advanced settings, and your stats will be more accurate.",
			"switchmodeconfirm": "Switching mode keeps the shared fields, but you should re-check the later rules and fee settings. Switch anyway?",
			"needmode": "Please choose Host a Game or Log Personal Result first",
			"negativesuffix": " cannot be negative",
			"labelbuyin": "Buy-in",
			"labelbuyinfee": "Buy-in Fee",
			"labelchip": "Starting Chips",
			"labelrebuycount": "Rebuy Count",
			"labelrebuybuyin": "Rebuy Cost",
			"labelrebuyfee": "Rebuy Fee",
			"labelrebuychip": "Rebuy Chips",
			"labelreentrycount": "Reentry Count",
			"labelreentrybuyin": "Reentry Cost",
			"labelreentryfee": "Reentry Fee",
			"labelreentrychip": "Reentry Chips",
			"labeladdoncount": "Addon Count",
			"labeladdonbuyin": "Addon Cost",
			"labeladdonfee": "Addon Fee",
			"labeladdonchip": "Addon Chips",
			"labelguaranteedprize": "Guaranteed Prize",
			"labelpersonalreentrycount": "Personal Re-entry Count",
			"labelpersonalreentrybuyin": "Re-entry Cost",
			"labelpersonalreentryfee": "Re-entry Fee",
			"labelwinprice": "Prize Amount",
			"labeltotalbuyin": "Total Buy-in",
			"labelplace": "Place",
			"labelunknown": "Field",
			"needname": "Please enter the session name",
			"heading": "New Session",
			"guidekicker": "Related guide",
			"guidenote": "Hosting a game? Start with the host quick guide. Just recording your own result? Go straight to the player section.",
			"guidehostlink": "Host setup guide",
			"guideplayerlink": "Player record guide",
			"modehostedtitle": "I want to run a game I can manage",
			"modehosteddesc": "For hosts. You will set buy-ins, rebuys, registration and player rules.",
			"modepersonaltitle": "I just want to record my own result",
			"modepersonaldesc": "For personal records. Host-only settings are hidden.",
			"modecurrent": "Current mode",
			"changemode": "Change",
			"sectionbasic": "Basic Info",
			"sectionregister": "Registration & Rules",
			"sectionfee": "Fees & Advanced",
			"sectionadvanced": "Advanced",
			"aititle": "⚡ AI event import",
			"aidesc": "Paste an event page from another site to auto-fill the name, starting stack, buy-in, start time and blind structure.",
			"aiplaceholder": "Paste the whole event description here, for example copied from an event page…",
			"aibutton": "Parse and fill",
			"step1title": "Step 1. Basic info",
			"step1kicker": "Start here",
			"labelgamemode": "Game mode",
			"gamemodenote": "This affects how the session is grouped and summarised.",
			"labelname": "Session name",
			"nameplaceholder": "For example: Friday Deepstack Bounty",
			"namenote": "Make the time or the hook obvious at a glance.",
			"labelvenue": "Venue",
			"venuenote": "No venue yet? Create one on the venue / club page first.",
			"labelstartdate": "Start date",
			"labelstarttime": "Start time",
			"labelendtime": "End time",
			"step2title": "Step 2. Registration & player rules",
			"step2kicker": "Depends on the mode",
			"step2hostedtitle": "Hosted games keep the full rule set",
			"step2hosteddesc": "First decide whether players can register and whether rebuy / re-entry / add-on are allowed, then set the amounts and stacks in the next step.",
			"rebuyexplain": "Rebuy: buy more chips before being eliminated; the player keeps the same entry.",
			"reentryexplain": "Re-entry: come back after elimination; counts as a fresh entry.",
			"addonexplain": "Add-on: extra chips at a set point, normally without needing to be eliminated.",
			"labellinkuser": "User link",
			"linkusernote": "Lets players see this session and link it to their account.",
			"labelopenregistration": "Open registration",
			"openregistrationnote": "Players can register from the session list. Requires user link to be on.",
			"labelprivate": "Private game",
			"privatenote": "Limits visibility. Check your invite flow as well.",
			"step2personaltitle": "Personal records keep only your own entry",
			"step2personaldesc": "This is not the host settings page. Step 2 only covers whether you re-entered and whether you made the money or the final table.",
			"personalreentrynote": "If you were eliminated and bought back in, enter how many times.",
			"labelitm": "In the money (ITM)",
			"itmnote": "Tick this if you finished in a paid position.",
			"labelft": "Made the final table",
			"ftnote": "Tick this if you reached the final table.",
			"step3title": "Step 3. Fees & advanced",
			"step3kicker": "Watch that amounts and counts line up",
			"rebuynote": "Buying in again before elimination, normally to keep the same entry and standing.",
			"reentrynote": "Re-registering after elimination. Fee and starting stack can be set separately.",
			"addonnote": "Extra chips at a set point without needing elimination, usually around a break.",
			"rebuysection": "Rebuy settings",
			"reentrysection": "Re-entry settings",
			"addonsection": "Add-on settings",
			"guaranteenote": "Leave at 0 if there is no guarantee.",
			"step3personaltitle": "Record what you actually spent and won",
			"step3personaldesc": "If you re-entered, fill in both the count and the fee so total buy-in and profit add up later.",
			"labelprize": "Prize",
			"prizeplaceholder": "Leave blank if there is no prize",
			"step4title": "Advanced settings (optional)",
			"step4kicker": "Defaults are fine; you can change them later",
			"labeleventtype": "Event type",
			"labelgametype": "Game type",
			"labellimittype": "Limit type",
			"labelchiptype": "Chip type",
			"labelnote": "Note",
			"descriptionplaceholder": "Anything worth remembering: the hook, the event name, blind notes…",
			"descriptionnote": "Use this for extra context so the session name does not have to carry every rule.",
			"submit": "Create session",
			"needclub": "Please choose a venue",
			"needdate": "Please choose a start date",
			"needstarttime": "Please choose a start time",
			"needendtime": "Please choose an end time",
			"endtimebeforestart": "End time must be later than start time",
			"needrebuyfee": "Rebuy count is set; please fill in the rebuy cost",
			"needreentryfee": "Reentry count is set; please fill in the reentry cost",
			"needreentrychip": "Reentry count is set; please fill in the reentry chips",
			"needaddonfee": "Addon count is set; please fill in the addon cost",
			"needaddonchip": "Addon count is set; please fill in the addon chips",
			"needpersonalreentryfee": "Personal re-entry count is set; please fill in the re-entry cost",
			"previewname": "Name: ",
			"previewchip": "Starting Chips: ",
			"previewbuyin": "Buy-in: ",
			"previewstarttime": "Start Time: ",
			"previewderived": " (derived from registration close time)",
			"previewregclose": "Registration closes ",
			"previewregclosefail": ": cannot derive the start time (the source does not mark the registration-close level), please fill it in yourself",
			"previewstructure": "Structure: ",
			"previewlevelunit": " levels + ",
			"previewbreakunit": " breaks",
			"previewregcloselevel": ", registration closes at L",
			"aineedtext": "Please paste the tournament content first",
			"aiwait1": "AI is parsing...",
			"aiwait2": "AI is thinking...",
			"aiwait3": "AI is organizing the structure...",
			"aiwait4": "Almost there, please wait...",
			"aiwait5": "The content is long, AI is still working, please wait a little longer...",
			"aiparsefail": "Parsing failed, please try again",
			"airuleonlyprefix": "AI is disabled; structure parsed by rules only (",
			"airuleonlysuffix": " items)",
			"aifilledprefix": "Fields filled, and ",
			"aifilledsuffix": " schedule items imported (applied automatically after the session is created)",
			"aifilledonly": "Fields filled",
			"aitimeout": "AI parsing timed out, please shorten the content or try again later",
			"ainetworkfail": "Network problem, please try again",
			"selectclubplaceholder": "Please choose a venue",
			"creating": "Creating...",
			"createsuccess": "Created",
			"backtolistcheck": "Check the list",
			"timeouttoast": "Connection timed out. The session may already be created; please check the session list first",
			"timeoutwarn": "Request timed out. The session may already exist — check the session list before submitting again.",
		},
		"controlpage": {
			"brandtitle": "Display Brand",
			"brandname": "Brand",
			"brandlogo": "Logo URL",
			"brandcolor": "Accent",
			"brandclear": "Clear",
			"brandreload": "↺ Reload",
			"brandsave": "Save and Apply",
			"brandhint": "Affects this session's display only. Leave blank for no branding. The display picks up changes on its next sync.",
			"brandsaved": "Display brand updated",
			"brandreloaded": "Reloaded",
			"brandsavefailed": "Save failed. Check your permission or try again.",
			"brandaction": "Edit display brand",
			"brandcolordefault": "Using the built-in green when no accent is set.",
			"brandcolorlow": "Contrast too low, hard to read on the display",
			"brandcolormid": "Contrast is low, may be hard to read from a distance",
			"brandcolorok": "Contrast is good",
		...
		"apidocpage": {
			"searchlabel": "Search API endpoints",
