...
ajax("GET",AJAXURL+"gettable/"+id,function(event,data){
    if(data["success"]){
        ...
        function handleActionClick(event){
            ...
            let modelIndex=-1
            for(let mi=0;mi<bittingdata[currentRound].length;mi=mi+1){
            ...
            if(act === "raise" && modelIndex !== -1){
                ...
                if(smallblindseat > 0){
                    ...
                    if(sbAlive){
                        ...
                        let found=false
                        for(let si=0;si<bittingdata[currentRound].length;si=si+1){
                            if(bittingdata[currentRound][si] && bittingdata[currentRound][si].seat===smallblindseat && si > modelIndex){
                                found=true
                                break
                            }
                        }
                ...
                if(bigblindseat > 0){
                    ...
                    if(bbAlive){
                        let found=false
                        for(let si=0;si<bittingdata[currentRound].length;si=si+1){
                            if(bittingdata[currentRound][si] && bittingdata[currentRound][si].seat===bigblindseat && si > modelIndex){
                                found=true
                                break
                            }
                        }
