let RULES=[
	...
	{tzh:"亮牌定輸贏",ten:"Cards Speak",zh:"攤牌時以實際牌面決定大小（cards speak），即使玩家報錯牌型。",en:"At showdown the actual cards determine the winner (cards speak), even if a hand is misread aloud."},
	...
	{tzh:"全下不足額",ten:"All-in Under Min-raise",zh:"全下金額不足一個完整加注時，通常不重新開啟先前已行動玩家的加注權。",en:"An all-in for less than a full raise generally does not reopen betting for players who already acted."},
	...
	{tzh:"保護你的牌",ten:"Protect Your Hand",zh:"玩家有責任保護手牌；未受保護而被收走或與棄牌混到，通常判死牌。",en:"Players must protect their hand; an unprotected hand that gets mucked or fouled is usually dead."},
