let DEALEROP=[
	...
	{tzh:"行動順序",ten:"Action Order",zh:"翻牌前由大盲左手開始，翻牌後由按鈕左手第一個有牌玩家開始。",en:"Preflop starts left of the big blind; postflop starts with the first live player left of the button."},
	...
	{tzh:"亮牌處理",ten:"Exposed Card",zh:"莊家誤亮的牌通常作廢、依規定補牌；玩家自行亮牌不適用此規定。",en:"A card the dealer exposes is usually replaced per procedure; this does not apply to a player exposing their own card."},
	{tzh:"邊池處理",ten:"Side Pots",zh:"有全下且金額不同時，分別計算主池與邊池，確認可贏得各池的玩家。",en:"With all-ins of different sizes, build separate main and side pots and confirm who is eligible for each."},
